...
capture_framework_diagnostics() {
  ...
  built_framework="$tools_pack_dir/out/mac/namespaces/$namespace/builder/mac-arm64/Design For AIR Beta.app/Contents/Frameworks/Electron Framework.framework"
