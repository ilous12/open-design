...
source_dmg="$tools_pack_dir/out/mac/namespaces/$TOOLS_PACK_NAMESPACE/dmg/Design For AIR-$TOOLS_PACK_NAMESPACE.dmg"
source_zip="$tools_pack_dir/out/mac/namespaces/$TOOLS_PACK_NAMESPACE/zip/Design For AIR-$TOOLS_PACK_NAMESPACE.zip"
...
release_notes="${RELEASE_NOTES:-Design For AIR $RELEASE_VERSION$asset_suffix}"
