...
## design for air orchestration mode

When this skill is invoked inside design for air, treat it as the design-flow
...
3. Search across every available design for air resource, not only this skill:
