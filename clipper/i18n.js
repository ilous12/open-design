// design for air Web Clipper i18n runtime.
//
...
(function () {
  ...
  const en = {
    extensionName: 'design for air Web Clipper',
    extensionDescription: 'Clip pages, design systems, screenshots, images, and Figma import JSON into your design for air Library.',
    ...
    hintHtml: '<strong>design for air</strong> is not running. Start the app, then reopen this popup - the clipper connects automatically.',
    advanced: 'Advanced',
    ...
    refreshPageTitle: 'Reload this page so design for air can attach',
    ...
    openDesignNotRunning: 'design for air is not running - start the app first.',
    savedConnected: 'Saved - connected.',
    savedNotDetected: 'Saved, but design for air was not detected at that URL.',
    ...
    odNotAttached: 'design for air has not attached to this page yet.',
    ...
    toolbarDragLabel: 'Drag the design for air bar',
    toolbarHomeTip: 'design for air - open-design.ai',
    toolbarHomeLabel: 'design for air home',
    ...
    toolbarHide: 'Hide design for air bar',
    openDesignStartApp: 'design for air is not running - start the app',
    ...
    saveImageToLibrary: 'Save image to design for air Library',
    saveImageToOpenDesign: 'Save image to design for air',
  ...
  const overrides = {
    id: {
      extensionDescription: 'Klip halaman, sistem desain, tangkapan layar, gambar, dan JSON impor Figma ke Library design for air.',
    ...
    de: {
      extensionDescription: 'Sammle Seiten, Designsysteme, Screenshots, Bilder und Figma-Import-JSON in deiner design for air Library.',
    ...
    'zh-CN': {
      extensionName: 'design for air 网页剪藏',
      extensionDescription: '将网页、设计系统、截图、图片和 Figma 导入 JSON 剪藏到 design for air 素材库。',
      ...
      hintHtml: '<strong>design for air</strong> 未运行。启动应用后重新打开此弹窗，插件会自动连接。',
      ...
      daemonUrl: 'Daemon 地址', save: '保存', refreshPage: '刷新页面', refreshPageTitle: '刷新此页面以便 design for air 挂载',
      toggleOnPageBar: '切换页面浮条', toggleImageHover: '切换图片悬浮捕获按钮',
      openDesignNotRunning: 'design for air 未运行，请先启动应用。', savedConnected: '已保存，已连接。',
      savedNotDetected: '已保存，但该地址未检测到 design for air。', capturingPage: '正在捕获页面...',
      ...
      odNotAttached: 'design for air 尚未挂载到此页面。', elementPickerUnavailable: '此页面不可使用元素选择器，请尝试普通网站。',
      ...
      toolbarDrag: '拖动移动', toolbarDragLabel: '拖动 design for air 浮条', toolbarCapturePage: '捕获页面 -> 素材库',
      ...
      toolbarHide: '隐藏 design for air 浮条', openDesignStartApp: 'design for air 未运行，请启动应用',
      ...
      saveImageToLibrary: '保存图片到 design for air 素材库', saveImageToOpenDesign: '保存图片到 design for air',
    ...
    'zh-TW': {
      extensionName: 'design for air 網頁剪藏',
      extensionDescription: '將網頁、設計系統、截圖、圖片和 Figma 匯入 JSON 剪藏到 design for air 素材庫。',
    ...
    'pt-BR': {
      extensionDescription: 'Capture páginas, kits de marca, screenshots, imagens e JSON de importação do Figma na sua Library design for air.',
    ...
    'es-ES': {
      extensionDescription: 'Guarda páginas, kits de marca, capturas, imágenes y JSON de importación de Figma en tu Library de design for air.',
    ...
    ru: {
      extensionDescription: 'Сохраняйте страницы, дизайн-системы, скриншоты, изображения и Figma import JSON в библиотеку design for air.',
    ...
    fa: {
      extensionDescription: 'صفحه‌ها، سیستم‌های طراحی، اسکرین‌شات‌ها، تصاویر و JSON واردسازی Figma را در کتابخانه design for air ذخیره کنید.',
    ...
    ar: {
      extensionDescription: 'احفظ الصفحات وأنظمة التصميم ولقطات الشاشة والصور وملف Figma JSON في مكتبة design for air.',
    ...
    ja: {
      extensionDescription: 'ページ、デザインシステム、スクリーンショット、画像、Figma インポート JSON を design for air Library に保存します。',
    ...
    ko: {
      extensionDescription: '페이지, 디자인 시스템, 스크린샷, 이미지, Figma 가져오기 JSON을 design for air Library에 저장합니다.',
    ...
    pl: {
      extensionDescription: 'Zapisuj strony, systemy projektowe, zrzuty ekranu, obrazy i JSON importu Figma w bibliotece design for air.',
    ...
    hu: {
      extensionDescription: 'Oldalak, designrendszerek, képernyőképek, képek és Figma import JSON mentése az design for air Librarybe.',
    ...
    fr: {
      extensionDescription: 'Capturez pages, systèmes de design, captures, images et JSON import Figma dans votre Library design for air.',
    ...
    uk: {
      extensionDescription: 'Зберігайте сторінки, дизайн-системи, скриншоти, зображення та Figma import JSON у бібліотеку design for air.',
    ...
    tr: {
      extensionDescription: 'Sayfaları, tasarım sistemlerini, ekran görüntülerini, görselleri ve Figma içe aktarma JSONunu design for air Libraryye kaydedin.',
    ...
    th: {
      extensionDescription: 'บันทึกหน้าเว็บ ระบบดีไซน์ ภาพหน้าจอ รูปภาพ และ Figma import JSON ไปยัง design for air Library',
    ...
    it: {
      extensionDescription: 'Salva pagine, design system, screenshot, immagini e JSON di importazione Figma nella Library design for air.',
    ...
    vi: {
      extensionDescription: 'Lưu trang, hệ thống thiết kế, ảnh chụp màn hình, hình ảnh và JSON nhập Figma vào design for air Library.',
    ...
    nl: {
      extensionDescription: 'Sla pagina’s, designsystemen, screenshots, afbeeldingen en Figma-import-JSON op in je design for air Library.',
