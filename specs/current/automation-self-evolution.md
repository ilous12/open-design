...
Automations should become the product-wide loop that lets design for air improve
...
design for air becomes a self-evolving design agent when every useful run can
