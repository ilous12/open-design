  ...
  <body>
    <main>
      <section class="panel">
        ...
        <h2>최신 설치 파일</h2>
        <ul>
          <li><a href="https://github.com/${RELEASE_PUBLIC_GH_REPO:-<owner>/<repo>}/releases/latest">최신 릴리스에서 설치 파일 받기</a></li>
          <li><a href="https://github.com/${RELEASE_PUBLIC_GH_REPO:-<owner>/<repo>}/releases">전체 릴리스 목록 보기</a></li>
        </ul>
        <h2>운영체제별 파일</h2>
        <ul>
        ...
        <h2>업데이트 피드</h2>
        <ul>
          <li><a href="./${latest_prefix}/metadata.json">최신 메타데이터</a></li>
          <li><a href="./${latest_prefix}/latest-mac.yml">macOS 업데이트 피드</a></li>
          <li><a href="./${latest_prefix}/latest.yml">Windows 업데이트 피드</a></li>
        </ul>
        <h2>배포 구조</h2>
