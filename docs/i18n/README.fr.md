<h1 align="center">design for air : l'alternative open source à Claude Design</h1>

> 🔥 **design for air 0.10.0 est là : l'espace de travail design Agentic tout-en-un.** Tout le métier tient désormais dans une seule fenêtre — partez d'une idée vague, découvrez des références, rassemblez la matière, éditez de manière interactive, mettez vos commentaires en file d'attente, peaufinez les animations, puis transmettez le résultat à un éditeur ou à un Code Agent — sans quitter l'application. Avec les sessions parallèles, ce n'est plus un assistant, mais une équipe de design locale qui travaille pour vous. [Télécharger 0.10.0](https://github.com/nexu-io/open-design/releases) · [Rejoindre la discussion](https://github.com/nexu-io/open-design/discussions/4153)
>
> ⚡ **design for air AMR (Agentic Model Router) — le service de modèles officiel.** Une seule recharge pour utiliser GPT, Claude, Gemini et DeepSeek directement dans design for air : plus de 20 modèles phares, zéro configuration, facturation à l'usage réel des tokens. [Essayer AMR](https://open-design.ai/amr/)
>
> 🏅 **Le programme design for air Fellow est désormais ouvert.** Si vous croyez vous aussi que le design devrait être ouvert — devenez design for air Fellow, façonnez le produit aux côtés de l'équipe principale et aidez davantage de personnes à participer à la définition de l'avenir du design. Détails → [`MAINTAINERS.md`](../../MAINTAINERS.md) et [Discord](https://discord.gg/mHAjSMV6gz).

<p align="center">
  <img src="https://repo-assets.open-design.ai/resources/images/hero.png" alt="design for air — l'alternative open source à Claude Design · 150 systèmes de design · 261 plugins · 21 agents de code · 14 fournisseurs de médias" width="100%" />
</p>
...
<sub><b>Intégrations</b> — connectez des systèmes externes et des outils MCP, et utilisez design for air depuis n'importe quel IDE, script ou automatisation.</sub>
</td>
</tr>
</table>
...
design for air (OD) est l'alternative open source. La même boucle, le même modèle mental orienté artefact, sans aucun verrouillage :
...
Le moyen le plus rapide d'utiliser design for air. Pas de Node, pas de pnpm, pas de clone.
...
Vous pouvez utiliser design for air sans jamais ouvrir l'interface graphique — appelez-le en tant que skill, plugin ou serveur MCP à l'intérieur de Claude Code, Codex, Cursor, Copilot, OpenClaw, Antigravity, Hermes, Kimi, et bien d'autres.
...
5. **design for air devient plus intelligent à mesure que vous l'utilisez.** Vos captures d'écran, polices, palettes et artefacts confirmés s'accumulent comme valeurs par défaut pour la session suivante. Moins de retouches, moins de dérive.

---

## Utilisez design for air depuis votre agent de code

design for air livre un **serveur MCP en stdio** et des **scripts d'installation** par agent. Tout agent compatible MCP dans un autre dépôt peut lire directement des fichiers de vos projets design for air locaux — tokens CSS, composants JSX, HTML d'entrée — comme une API structurée interrogeable par nom. L'agent voit toujours le fichier en direct, jamais un export périmé.
...
**261 plugins officiels** se trouvent dans [`plugins/_official/`](../../plugins/_official/). Chaque plugin est un **dossier d'agent-skill portable** — un `SKILL.md` (lisible par tout agent prenant en charge les Agent Skills), plus un manifeste `open-design.json` optionnel qui donne à design for air des métadonnées de marketplace, des entrées, des aperçus, des pipelines et des déclarations de capacités. Accédez directement à une catégorie :
...
Un plugin **n'a besoin au minimum que d'un `SKILL.md`** ; pour le lister dans la marketplace design for air, ajoutez un `open-design.json` :
...
pnpm guard && pnpm --filter @nn-design/plugin-runtime typecheck
```
...
1. Déposez le dossier du plugin dans [`plugins/community/`](../../plugins/community/) (plugins tiers), ou — pour le livrer empaqueté avec design for air — dans le tier correspondant de [`plugins/_official/`](../../plugins/_official/).
2. Passez la validation : `od plugin validate`, `pnpm guard`, `pnpm --filter @nn-design/plugin-runtime typecheck`.
...
- [x] **0.9.0** — design for air AMR (Model Router officiel intégré à l'application : zéro configuration, connexion en un clic)
...
design for air continue d'avancer parce que des contributeurs — designers, ingénieurs, auteurs de prompts — continuent de se présenter. Beaucoup des skills, systèmes de design et plugins les plus utilisés ont été écrits par des personnes extérieures à l'équipe principale.
...
pnpm --filter @nn-design/<package> test
...
### 🏅 Programme design for air Fellow

Nous recrutons des **design for air Fellows** dans le monde entier — les Fellows façonnent le produit aux côtés de l'équipe principale, représentent officiellement design for air dans leur région et font grandir la communauté localement, avec le soutien d'un financement ($1,000 / MR), de crédits LLM gratuits et d'une voie de revue directe. Détails → [`MAINTAINERS.md`](../../MAINTAINERS.md) et l'annonce sur [Discord](https://discord.gg/mHAjSMV6gz).
...
<a href="https://github.com/nexu-io/open-design/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=nexu-io/open-design&max=500&columns=20&anon=1&cache_bust=2026-06-29" alt="Contributeurs d'design for air" />
</a>
...
<picture>
  <img alt="design for air — métriques du dépôt" src="https://repo-assets.open-design.ai/resources/images/github-metrics.svg" />
</picture>
...
<p align="center">
  <a href="https://github.com/nexu-io/open-design"><img src="https://repo-assets.open-design.ai/resources/images/star-us.png" alt="Mettez une étoile à design for air sur GitHub — github.com/nexu-io/open-design" width="100%" /></a>
</p>
...
<a href="https://star-history.com/#nexu-io/open-design&Date">
  <picture>
    ...
    <img alt="Historique des étoiles d'design for air" src="https://api.star-history.com/svg?repos=nexu-io/open-design&type=Date&cache_bust=2026-06-29" />
  </picture>
</a>
...
| [`heygen-com/hyperframes`](https://github.com/heygen-com/hyperframes) | Le framework de motion graphics HTML→MP4, intégré comme `hyperframes-html` de première classe dans design for air. |
