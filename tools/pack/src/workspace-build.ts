...
const BUILD_COMMANDS = [
  { args: ["--filter", "@nn-design/release", "build"] },
  { args: ["--filter", "@nn-design/components", "build"] },
  { args: ["--filter", "@nn-design/contracts", "build"] },
  { args: ["--filter", "@nn-design/registry-protocol", "build"] },
  { args: ["--filter", "@nn-design/sidecar-proto", "build"] },
  { args: ["--filter", "@nn-design/launcher-proto", "build"] },
  { args: ["--filter", "@nn-design/sidecar", "build"] },
  { args: ["--filter", "@nn-design/platform", "build"] },
  { args: ["--filter", "@nn-design/download", "build"] },
  { args: ["--filter", "@nn-design/host", "build"] },
  { args: ["--filter", "@nn-design/agui-adapter", "build"] },
  { args: ["--filter", "@nn-design/plugin-runtime", "build"] },
  { args: ["--filter", "@nn-design/diagnostics", "build"] },
  { args: ["--filter", "@nn-design/daemon", "build"] },
  { args: ["--filter", "@nn-design/web", "build"], env: ["OD_WEB_OUTPUT_MODE"] },
  { args: ["--filter", "@nn-design/web", "build:sidecar"] },
  { args: ["--filter", "@nn-design/desktop", "build"] },
  { args: ["--filter", "@nn-design/packaged", "build"] },
] as const;
