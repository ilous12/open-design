...
- Keep Korean nouns explicit: 요금, 사용량, 혜택, 로밍, 고객지원, 신청내역.

## 4. Voice & Tone

- **Adjectives:** 신뢰감 있다, 명확하다, 빠르다, 정돈되어 있다, 공식적이다, 실용적이다
...
- **Use:** 조회, 변경, 납부, 확인, 신청, 안내, 바로가기, 이용내역, 빠른 처리, 고객센터
- **Avoid:** 과도한 마케팅 수사, 지나친 감탄형 카피, 불필요한 영문 조합, 추상적 혁신 문장, 복잡한 법률문장 남발

### Messaging pillars

- 먼저 상태를 보여준다: 내 요금, 내 사용량, 내 회선, 내 혜택.
- 다음 행동을 짧게 제시한다: 변경, 납부, 신청, 문의.
- 고객센터처럼 말한다: 문제 해결과 안내를 우선한다.
- 서비스 범위를 숨기지 않는다: 요금, 멤버십, 로밍, 분실, 번호 변경, FAQ.
- 운영형 정보는 단정하게 유지한다: 시각 장치보다 정보 구조를 우선한다.

## 5. Imagery

- **Style:** Minimal product illustrations, crisp interface captures, service icons, restrained lifestyle or benefit imagery
- **Subjects:** 내 회선/청구/사용량, 멤버십 혜택, 로밍, 고객지원, 매장/방문센터, 데이터/요금제
...
Use for 납부하기, 요금제 변경, 신청하기, 상담 연결, 가입/변경 CTA.
...
Use for 로그아웃, 상세 보기, 더보기, 필터, 관리 actions.
...
Use for 청구요금, 데이터 사용량, 회선 상태, 멤버십, 로밍, 문의 현황.
...
Use for 분실 신고, 번호 변경, FAQ, 매장 찾기, 데이터 선물.
...
- Default to Korean-first copy and practical portal headings.
- The core questions every SKT-T screen should answer are:
  - 내 상태가 무엇인가?
  - 지금 바로 할 수 있는 일은 무엇인가?
  - 문제가 생기면 어디로 가야 하는가?
