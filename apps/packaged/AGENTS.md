...
- `nd://` packaged entry routing to the internal web runtime.
...
- Consume `@nn-design/sidecar-proto`, `@nn-design/sidecar`, and `@nn-design/platform` primitives; do not hand-build stamp flags or process matching logic.
