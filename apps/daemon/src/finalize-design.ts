...
// tsconfig does not resolve the `@nn-design/contracts/api/chat` subpath
...
} from '@nn-design/contracts/api/finalize';
...
// canonical definitions live in @nn-design/contracts/api/finalize
