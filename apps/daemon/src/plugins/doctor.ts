...
//
//   - Validates the manifest using @nn-design/plugin-runtime's validateSafe.
...
import { manifestSourceDigest, resolveContext, validateSafe, type RegistryView } from '@nn-design/plugin-runtime';
import type { InstalledPluginRecord, PluginManifest } from '@nn-design/contracts';
