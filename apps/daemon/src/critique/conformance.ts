...
import type { DegradedReason, PanelEvent, PanelistRole } from '@nn-design/contracts/critique';
import { CRITIQUE_PROTOCOL_VERSION } from '@nn-design/contracts/critique';
