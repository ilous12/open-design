...
//
// Two contracts:
//   1. The Zod schema in @nn-design/contracts accepts the new
...
import { GenUISurfaceSpecSchema } from '@nn-design/contracts';
import { validateSafe } from '@nn-design/plugin-runtime';
