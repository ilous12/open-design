...
export type AgentGuideCopy = {
  ...
  // "With design for air" — the drive-to-OD section
  withOdTitle: string;
  withOdLead: string;
  withOdSteps: string[];
...
const INFO_PAGE_COPY: Partial<Record<LandingLocaleCode, InfoPageCopy>> = {
  en: {
    ...
    official: {
      title: 'Official design for air — Source page, GitHub, releases, and aliases',
      description:
        'Official source page for design for air (also searched as OpenDesign, open-design, opendesign, design for air AI, OD). Canonical site, GitHub repository, releases, Discord, license, and maintainer identity in one place.',
      breadcrumb: 'Official',
      label: 'Source · Nº 00',
      heading: 'Official design for air source page.',
      lead:
        'design for air (also searched as OpenDesign, open-design, opendesign, or design for air AI) is the official open-source AI design workspace from the nexu-io/open-design project. This page lists every canonical surface so you can verify the source for yourself.',
      ...
      aliases: [
        { label: 'design for air', body: 'display name in the product UI, blog, and READMEs.' },
        ...
        { label: 'design for air AI', body: 'long-form search variant for AI-design queries.' },
      ...
      maintainerBody:
        'design for air is developed in the open at github.com/nexu-io/open-design and released under the Apache-2.0 license. Issues, RFCs, and roadmap conversations happen on GitHub Issues and Discord.',
      runtimeTitle: 'What runs on your machine',
      runtimeBody: 'design for air ships three runnable surfaces — all open source, all local-first:',
      runtimeItems: [
    ...
    quickstart: {
      title: 'design for air quickstart — Install in three commands (Node 24, pnpm)',
      description:
        'Install design for air locally with three commands. Requirements (Node 24, pnpm 10.33.2), commands, expected output, troubleshooting, and how to generate your first design artifact with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen.',
      breadcrumb: 'Quickstart',
      label: 'Install · Nº 01',
      heading: 'design for air quickstart.',
      lead:
        'design for air runs entirely on your machine. Three commands gets you from a clean checkout to a running daemon, web UI, and your first generated design artifact.',
      ...
      nextItems: [
        ...
        { label: 'Compare design for air', body: 'with Claude Design, Figma Make, v0, and Lovable.' },
    ...
    agents: {
      title: 'design for air agents — {count} BYOK adapters',
      description:
        'design for air ships {count} BYOK adapters out of the box. Drive design from the same agent you use for code — no separate vendor login.',
      breadcrumb: 'Agents',
      label: 'Adapters · Nº 04',
      heading: (count) => `${count} BYOK agents, one skill protocol.`,
      lead: (count) =>
        `design for air ships ${count} first-party adapters out of the box. The same composable skills and portable DESIGN.md systems work with every one. BYOK throughout — your keys, your spend, your data.`,
      adaptersTitle: 'How adapters plug in',
      adaptersBody:
        'Every adapter is a thin shim between the agent native message format and design for air skill protocol. Adding a new adapter is a single file — no fork required.',
      tiers: [
        {
          label: 'Tier 1 — first-party tested',
          blurb:
            'Battle-tested daily by the design for air maintainers. Stream-JSON IPC where supported, full AskUserQuestion mid-turn, skill-aware system prompts.',
        },
        {
      ...
      byokLead: 'BYOK ("bring your own key") in design for air keeps credentials and spend on your side:',
      byokItems: [
      ...
      ctaBody:
        'Pick the agent already on your laptop, point design for air at it, and start rendering.',
    },
    compare: {
      title: 'design for air vs Figma, Lovable, Bolt, v0, Framer — honest comparisons',
      description:
        'Compare design for air to the major AI design and app-building tools. Hosted vs local-first, BYOK vs vendor-locked, single-shot generation vs portable DESIGN.md systems.',
      breadcrumb: 'Compare',
      label: 'Evaluation · Nº 02',
      heading: 'design for air vs everything else.',
      lead:
        'Short, honest summaries of how design for air relates to the other AI design and app-building tools you might be evaluating. Each links to a full, candid comparison.',
      toc: ['vs Claude Design', 'vs Figma', 'vs Lovable', 'vs Bolt', 'vs v0', 'vs Framer', 'Honest limits'],
      comparisons: [
        {
          competitor: 'Claude Design',
          summary:
            'Hosted product tied to a single vendor. design for air is local-first, BYOK, and Apache-2.0 — your skills and DESIGN.md live in your repo.',
          cta: 'Read the full comparison ->',
        },
        {
          competitor: 'Figma',
          summary:
            'Figma is a hosted, hands-on design canvas. design for air is agent-driven and local-first, with your brand and artifacts as files in your repo.',
          cta: 'Read the full comparison ->',
        },
        {
          competitor: 'Lovable',
          summary:
            'Lovable ships hosted prompt-to-app builds. design for air is the design-first, BYOK layer for the coding agent you already use.',
          cta: 'Read the full comparison ->',
        },
        {
          competitor: 'Bolt',
          summary:
            'Bolt builds running full-stack apps in the browser. design for air produces design artifacts you own, locally, with your own agent.',
          cta: 'Read the full comparison ->',
        },
        {
          competitor: 'v0',
          summary:
            'v0 generates hosted UI tuned for the Vercel and React stack. design for air generates design with any agent, locally, as files you own.',
          cta: 'Read the full comparison ->',
        },
        {
          competitor: 'Framer',
          summary:
            'Framer is a hosted no-code site builder. design for air is the open-source, agent-driven alternative that keeps design as files you deploy anywhere.',
          cta: 'Read the full comparison ->',
        },
      ],
      limitsTitle: "Honest limits — what design for air isn't",
      limitsBody:
        'design for air is not trying to be every hosted AI design tool. These questions describe the trade-offs instead of glossing them.',
      limitsFaq: [
        { name: 'Does design for air offer a hosted web sandbox?', text: 'No. design for air is local-first by design.' },
        { name: 'Can I use design for air without installing anything?', text: 'Not today. The minimum is a local daemon plus a coding agent.' },
        { name: 'Is design for air a v0 / Lovable / Bolt replacement?', text: 'It depends. design for air focuses on prompt-to-design-artifact via a skill protocol you can fork.' },
        { name: 'Does design for air send my data to Anthropic, OpenAI, or Google?', text: 'Only your prompt and skill context goes to the provider whose key you brought.' },
        { name: 'Can I self-host design for air on my own infrastructure?', text: 'Yes. Apache-2.0 license, Node 24 daemon, no required SaaS.' },
      ],
    },
    claudeAlternative: {
      title: 'Open-source Claude Design alternative — design for air (BYOK, local-first)',
      description:
        'design for air is the open-source, local-first alternative to Claude Design. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen.',
      breadcrumb: 'Open-source Claude Design alternative',
      label: 'Alternative · Nº 03',
      heading: 'Open-source Claude Design alternative.',
      lead:
        'design for air is the official open-source, local-first alternative to Claude Design. BYOK with the agent you already use, keep your brand as a portable DESIGN.md file, and ship artifacts as files in your project.',
      tldrTitle: 'TL;DR',
      tldrBody:
      ...
      localByokBody: [
        'design for air runs a desktop app, a local daemon, and Markdown skill/system catalogs on your machine.',
      ...
      pickOpenTitle: 'Pick design for air if',
      pickOpen: [
      ...
      migrateSteps: [
        'Install design for air from the quickstart.',
      ...
      faqTitle: 'FAQ',
      faq: [
        { name: 'Is design for air really a drop-in alternative to Claude Design?', text: 'Not literally, but they overlap on prompt-to-design-artifact use cases.' },
        { name: 'Can I use Claude as my agent in design for air?', text: 'Yes. design for air supports Claude Code and Anthropic API BYOK flows.' },
        { name: 'What happens to my Claude Design designs?', text: 'You can keep using Claude Design alongside design for air; migration is manual today.' },
        { name: 'Does design for air generate the same artifact types?', text: 'Yes for common types: landing pages, decks, dashboards, social posts, brand systems, and prototypes.' },
        ...
        { name: 'Who builds and maintains design for air?', text: 'The project lives at github.com/nexu-io/open-design and is Apache-2.0.' },
      ],
    ...
    alternatives: {
      lovable: {
        title: 'Open-source Lovable alternative — design for air (design-first, BYOK, local)',
        description:
          'design for air is the open-source, local-first alternative to Lovable for design-first work. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — artifacts ship as files in your repo.',
        breadcrumb: 'Open-source Lovable alternative',
        label: 'Alternative · Lovable',
        heading: 'Open-source Lovable alternative.',
        lead:
          'Lovable turns a prompt into a deployed full-stack app. design for air is a self-evolving design agent for Claude Code — local-first, BYOK, open source — focused on design artifacts and a portable brand rather than shipping the backend. Different primary job, overlapping prompt-to-UI surface.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'Lovable ships hosted apps; design for air ships design artifacts as files you own. If you want a design-first, BYOK, open-source workflow with your own agent, design for air is the alternative — and it is honest about where Lovable wins.',
        toc: ['Why people search', 'Local-first + BYOK', 'Feature comparison', 'Who should pick which', 'Migration / first run', 'FAQ'],
        ...
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'design for air runs a desktop app, a local daemon, and Markdown skill/system catalogs on your machine — no design output is forced through a vendor cloud.',
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'Is design for air a drop-in replacement for Lovable?', text: 'No. Lovable ships deployed full-stack apps; design for air is design-first and produces artifacts you own. They overlap on prompt-to-UI, not on hosting a backend.' },
          { name: 'Can design for air build a full app like Lovable?', text: 'design for air focuses on design artifacts, prototypes, and brand systems. For production backends and one-click hosting, Lovable is the better fit.' },
          { name: 'Which agent does design for air use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. API spend bills to your account.' },
          { name: 'Is design for air really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
          { name: 'Can I keep using Lovable alongside design for air?', text: 'Yes. Many teams prototype design in design for air and ship apps in Lovable; migration is manual today.' },
        ...
        rich: {
          heroCtaLead:
            'design for air is the open-source, local-first design layer around the coding agent you already use — your key, your files, a curated skill and design-system library.',
          heroCtaActions: [
            { label: 'Download design for air', href: '/download/', variant: 'primary' },
          ...
          heroImage: {
            ...
            alt: 'design for air vs Lovable — warm-paper editorial illustration of code converging into a design hub',
          },
          intro: [
            'Lovable turns a prompt into a deployed full-stack app. design for air is a self-evolving design agent for Claude Code and other coding agents — local-first, BYOK, Apache-2.0 — focused on producing design artifacts and a portable brand you keep as files in your own repo.',
          ...
          sections: [
            {
              ...
              blocks: [
                ...
                { kind: 'p', text: 'It is closed-source and runs in the vendor cloud, billed by subscription and per-message credits. That is a different posture from design for air, which is a local-first, open-source design agent you point your own coding agent at — and the two overlap on prompt-to-UI, not on hosting a backend.' },
                { kind: 'ul', items: [
            ...
            },
            {
              ...
              blocks: [
                { kind: 'p', text: 'design for air runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine. No design output is forced through a vendor cloud, and your brand lives in your repo as a portable DESIGN.md file every skill respects.' },
                { kind: 'p', text: 'You bring your own agent key. Credentials stay in local config or environment variables — design for air never proxies them — and the API spend bills directly to you.' },
              ],
            },
            {
              id: 'compare',
              heading: 'design for air vs Lovable, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'design for air', 'Lovable'], rows: [
                ...
                { kind: 'p', text: 'Where Lovable wins: if your goal is a deployed, hosted full-stack app with the backend wired up for you, Lovable does that out of the box and design for air does not. design for air is design-first.' },
              ],
            },
            {
              id: 'who-picks',
              ...
              blocks: [
                ...
                { kind: 'p', text: 'Pick design for air if:' },
                { kind: 'ul', items: [
                  'You want design artifacts and a brand as version-controlled files.',
                  'You want BYOK with your existing coding agent.',
                  'You want open source you can fork, rebrand, embed in CLI, or self-host.',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from Lovable into design for air',
              blocks: [
          ...
          faq: [
            { name: 'Is design for air a drop-in replacement for Lovable?', text: 'No. Lovable ships deployed full-stack apps; design for air is design-first and produces artifacts you own. They overlap on prompt-to-UI, not on hosting a backend.' },
            { name: 'Can design for air build a full app like Lovable?', text: 'design for air focuses on design artifacts, prototypes, and brand systems. For production backends and one-click hosting, Lovable is the better fit.' },
            { name: 'Which agent does design for air use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. API spend bills to your account and credentials are never proxied through us.' },
            { name: 'Is design for air really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
            { name: 'Can I keep using Lovable alongside design for air?', text: 'Yes. Many teams prototype design in design for air and ship apps in Lovable; migration is manual today.' },
            { name: 'Is design for air affiliated with Lovable?', text: 'No. design for air is an independent, open-source project. Lovable is a trademark of its owner; this is an unaffiliated comparison.' },
          ],
          ctaTitle: 'Design-first, in three commands.',
          ctaBody:
            'Star the repo, grab the desktop build, or run the install in your terminal. Your DESIGN.md system stays in your repo from the first render onward.',
      ...
      figma: {
        title: 'Open-source Figma alternative — design for air (design-first, BYOK, local)',
        description:
          'design for air is the open-source, local-first alternative to Figma for agent-driven design. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — your brand and artifacts live as files in your repo.',
        breadcrumb: 'Open-source Figma alternative',
        label: 'Alternative · Figma',
        heading: 'Open-source Figma alternative.',
        lead:
          'Figma is a hosted, collaborative canvas you design on by hand. design for air is a self-evolving design agent for Claude Code — local-first, BYOK, Apache-2.0 — where you drive design through your coding agent and keep a portable brand as files. Different shape, same goal: shipped interfaces.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'Figma is a manual cloud design tool; design for air is an agent-driven, local-first, open-source design layer. If you want files in your repo and BYOK over a hosted canvas, design for air is the alternative — and it is honest about where Figma wins.',
        toc: ['Why people search', 'Local-first + BYOK', 'Feature comparison', 'Who should pick which', 'Migration / first run', 'FAQ'],
        ...
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'design for air runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine — your designs are files, not cloud documents.',
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'Is design for air a drop-in replacement for Figma?', text: 'No. Figma is a hands-on collaborative canvas; design for air is an agent-driven, local-first design layer. They overlap on producing interfaces, not on real-time canvas editing.' },
          { name: 'Can I still use Figma alongside design for air?', text: 'Yes. Many teams design in Figma and use design for air to generate and iterate from a portable brand; migration is manual today.' },
          { name: 'Which agent does design for air use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. Credentials are never proxied through us.' },
          { name: 'Is design for air really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
          { name: 'Is design for air affiliated with Figma?', text: 'No. design for air is an independent, open-source project. Figma is a trademark of its owner; this is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Design-first, in three commands.',
        ctaBody:
          'Star the repo, grab the desktop build, or run the install in your terminal. Your DESIGN.md system stays in your repo from the first render onward.',
        rich: {
          ...
          heroImage: {
            ...
            alt: 'design for air vs Figma — warm-paper editorial illustration of code converging into a design hub',
          },
          intro: [
            'Figma turns a cloud canvas into shared, hands-on interface design. design for air is a self-evolving design agent for Claude Code and other coding agents — local-first, BYOK, Apache-2.0 — where you drive design through your agent and keep a portable brand as files in your own repo.',
          ...
          sections: [
            {
              ...
              blocks: [
                ...
                { kind: 'p', text: 'It is closed-source and runs in the vendor cloud, billed per editor seat. design for air is a different shape: a local-first, open-source design agent you point your own coding agent at — the two overlap on producing interfaces, not on real-time canvas editing.' },
                { kind: 'ul', items: [
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'p', text: 'design for air runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine. Your designs are files, not cloud documents, and your brand lives in your repo as a portable DESIGN.md file every skill respects.' },
                { kind: 'p', text: 'You bring your own agent key. Credentials stay in local config or environment variables — design for air never proxies them — and the API spend bills directly to you.' },
              ],
            },
            {
              id: 'compare',
              heading: 'design for air vs Figma, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'design for air', 'Figma'], rows: [
                ...
                { kind: 'p', text: 'Where Figma wins: hands-on vector editing, a real-time multiplayer canvas, and a deep, mature plugin and component ecosystem. If that hands-on canvas is the job, Figma is hard to beat — design for air is design-first and agent-driven instead.' },
              ],
            },
            {
              id: 'who-picks',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from Figma into design for air',
              blocks: [
      ...
      bolt: {
        title: 'Open-source Bolt alternative — design for air (design-first, BYOK, local)',
        description:
          'design for air is the open-source, local-first alternative to Bolt (bolt.new) for design-first work. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — artifacts ship as files in your repo.',
        breadcrumb: 'Open-source Bolt alternative',
        label: 'Alternative · Bolt',
        heading: 'Open-source Bolt alternative.',
        lead:
          'Bolt (bolt.new) turns a prompt into a running full-stack app in the browser. design for air is a self-evolving design agent for Claude Code — local-first, BYOK, open source — focused on design artifacts and a portable brand rather than shipping the backend. Different primary job, overlapping prompt-to-UI surface.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'Bolt ships hosted apps; design for air ships design artifacts as files you own. If you want a design-first, BYOK, open-source workflow with your own agent, design for air is the alternative — and it is honest about where Bolt wins.',
        toc: ['Why people search', 'Local-first + BYOK', 'Feature comparison', 'Who should pick which', 'Migration / first run', 'FAQ'],
        ...
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'design for air runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine — no design output is forced through a vendor cloud.',
          'You bring your own agent key; credentials stay local and never proxy through us, and API spend bills to you.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'Is design for air a drop-in replacement for Bolt?', text: 'No. Bolt ships running full-stack apps; design for air is design-first and produces artifacts you own. They overlap on prompt-to-UI, not on running a backend.' },
          { name: 'Can design for air build a full app like Bolt?', text: 'design for air focuses on design artifacts, prototypes, and brand systems. For an instant in-browser full-stack app, Bolt is the better fit.' },
          { name: 'Which agent does design for air use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. API spend bills to your account and credentials are never proxied through us.' },
          { name: 'Is design for air really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
          { name: 'Is design for air affiliated with Bolt?', text: 'No. design for air is an independent, open-source project. Bolt and bolt.new are trademarks of their owner; this is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Design-first, in three commands.',
        ctaBody:
          'Star the repo, grab the desktop build, or run the install in your terminal. Your DESIGN.md system stays in your repo from the first render onward.',
        rich: {
          ...
          heroImage: {
            ...
            alt: 'design for air vs Bolt — warm-paper editorial illustration of code converging into a design hub',
          },
          intro: [
            'Bolt turns a prompt into a running full-stack app in the browser. design for air is a self-evolving design agent for Claude Code and other coding agents — local-first, BYOK, Apache-2.0 — focused on producing design artifacts and a portable brand you keep as files in your own repo.',
          ...
          sections: [
            {
              ...
              blocks: [
                ...
                { kind: 'p', text: 'It is closed-source and hosted, billed by subscription and per-token credits. design for air is a different posture: a local-first, open-source design agent you point your own coding agent at — and the two overlap on prompt-to-UI, not on running a backend.' },
                { kind: 'ul', items: [
            ...
            {
              id: 'compare',
              heading: 'design for air vs Bolt, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'design for air', 'Bolt'], rows: [
                ...
                { kind: 'p', text: 'Where Bolt wins: if your goal is an instant, running full-stack app in the browser with the dev environment wired up for you, Bolt does that out of the box. design for air is design-first.' },
              ],
            },
            {
              id: 'who-picks',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from Bolt into design for air',
              blocks: [
      ...
      v0: {
        title: 'Open-source v0 alternative — design for air (design-first, BYOK, local)',
        description:
          'design for air is the open-source, local-first alternative to v0 by Vercel for design-first work. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — artifacts ship as files in your repo.',
        breadcrumb: 'Open-source v0 alternative',
        label: 'Alternative · v0',
        heading: 'Open-source v0 alternative.',
        lead:
          'v0 by Vercel turns a prompt into hosted UI components. design for air is a self-evolving design agent for Claude Code — local-first, BYOK, open source — that drives any coding agent and keeps your brand and artifacts as files. Closest overlap of the bunch: prompt-to-UI, different posture.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'v0 generates UI in Vercel’s hosted flow; design for air generates design with your own agent, locally, as files you own. If you want BYOK, any agent, and open source over a hosted generator, design for air is the alternative — and it is honest about where v0 wins.',
        toc: ['Why people search', 'Local-first + BYOK', 'Feature comparison', 'Who should pick which', 'Migration / first run', 'FAQ'],
        ...
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'design for air runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine — your UI is files, not hosted generations.',
          'You bring your own agent key; credentials stay local and never proxy through us, and API spend bills to you.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'Is design for air a drop-in replacement for v0?', text: 'No. v0 generates UI in Vercel’s hosted flow; design for air is design-first and produces artifacts you own with any agent. They overlap on prompt-to-UI, not on the Vercel-hosted pipeline.' },
          { name: 'Does design for air lock me to a stack?', text: 'No. BYOK with any supported agent, and your output is plain files in your repo — not tied to one framework or host.' },
          { name: 'Which agent does design for air use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. API spend bills to your account and credentials are never proxied through us.' },
          { name: 'Is design for air really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
          { name: 'Is design for air affiliated with v0 or Vercel?', text: 'No. design for air is an independent, open-source project. v0 and Vercel are trademarks of their owner; this is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Design-first, in three commands.',
        ctaBody:
          'Star the repo, grab the desktop build, or run the install in your terminal. Your DESIGN.md system stays in your repo from the first render onward.',
        rich: {
          ...
          heroImage: {
            ...
            alt: 'design for air vs v0 — warm-paper editorial illustration of code converging into a design hub',
          },
          intro: [
            'v0 by Vercel turns a prompt into hosted UI components, tuned for the React and Vercel ecosystem. design for air is a self-evolving design agent for Claude Code and other coding agents — local-first, BYOK, Apache-2.0 — focused on producing design artifacts and a portable brand you keep as files in your own repo.',
          ...
          sections: [
            {
              ...
              blocks: [
                ...
                { kind: 'p', text: 'It is closed-source and runs in the vendor cloud, billed by subscription and per-generation credits. design for air is a different posture: a local-first, open-source design agent you point your own coding agent at — overlapping on prompt-to-UI, not on the Vercel-hosted pipeline.' },
                { kind: 'ul', items: [
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'p', text: 'design for air runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine. Your UI is files, not hosted generations, and your brand lives in your repo as a portable DESIGN.md file every skill respects.' },
                { kind: 'p', text: 'You bring your own agent key. Credentials stay in local config or environment variables — design for air never proxies them — and the API spend bills directly to you.' },
              ],
            },
            {
              id: 'compare',
              heading: 'design for air vs v0, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'design for air', 'v0'], rows: [
                ...
                { kind: 'p', text: 'Where v0 wins: if you live in the Vercel, Next.js and React ecosystem and want UI generated and deployed in one tight hosted flow, v0 is built for exactly that. design for air is design-first and stack-agnostic.' },
              ],
            },
            {
              id: 'who-picks',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from v0 into design for air',
              blocks: [
      ...
      framer: {
        title: 'Open-source Framer alternative — design for air (design-first, BYOK, local)',
        description:
          'design for air is the open-source, local-first alternative to Framer for agent-driven design. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — your brand and artifacts live as files in your repo.',
        breadcrumb: 'Open-source Framer alternative',
        label: 'Alternative · Framer',
        heading: 'Open-source Framer alternative.',
        lead:
          'Framer is a hosted, no-code visual builder for designing and publishing sites. design for air is a self-evolving design agent for Claude Code — local-first, BYOK, open source — where you drive design through your coding agent and keep a portable brand as files. Different shape, same goal: shipped interfaces.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'Framer is a hosted no-code site builder; design for air is an agent-driven, local-first, open-source design layer. If you want files in your repo and BYOK over a hosted canvas, design for air is the alternative — and it is honest about where Framer wins.',
        toc: ['Why people search', 'Local-first + BYOK', 'Feature comparison', 'Who should pick which', 'Migration / first run', 'FAQ'],
        ...
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'design for air runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine — your designs are files, not a hosted project.',
          'You bring your own agent key; credentials stay local and never proxy through us, and API spend bills to you.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'Is design for air a drop-in replacement for Framer?', text: 'No. Framer is a hosted no-code site builder; design for air is an agent-driven, local-first design layer. They overlap on producing interfaces, not on no-code publishing and hosting.' },
          { name: 'Can design for air publish a site like Framer?', text: 'design for air produces design artifacts and code you own; you deploy them yourself. For an all-in-one no-code builder plus hosting, Framer is the better fit.' },
          { name: 'Which agent does design for air use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. Credentials are never proxied through us.' },
          { name: 'Is design for air really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
          { name: 'Is design for air affiliated with Framer?', text: 'No. design for air is an independent, open-source project. Framer is a trademark of its owner; this is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Design-first, in three commands.',
        ctaBody:
          'Star the repo, grab the desktop build, or run the install in your terminal. Your DESIGN.md system stays in your repo from the first render onward.',
        rich: {
          ...
          heroImage: {
            ...
            alt: 'design for air vs Framer — warm-paper editorial illustration of code converging into a design hub',
          },
          intro: [
            'Framer turns a hosted, no-code canvas into designed and published websites. design for air is a self-evolving design agent for Claude Code and other coding agents — local-first, BYOK, Apache-2.0 — where you drive design through your agent and keep a portable brand as files in your own repo.',
          ...
          sections: [
            {
              ...
              blocks: [
                ...
                { kind: 'p', text: 'It is closed-source and runs in the vendor cloud, billed by subscription. design for air is a different posture: a local-first, open-source design agent you point your own coding agent at — overlapping on producing interfaces, not on no-code publishing and hosting.' },
                { kind: 'ul', items: [
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'p', text: 'design for air runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine. Your designs are files, not a hosted project, and your brand lives in your repo as a portable DESIGN.md file every skill respects.' },
                { kind: 'p', text: 'You bring your own agent key. Credentials stay in local config or environment variables — design for air never proxies them — and the API spend bills directly to you.' },
              ],
            },
            {
              id: 'compare',
              heading: 'design for air vs Framer, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'design for air', 'Framer'], rows: [
                ...
                { kind: 'p', text: 'Where Framer wins: if you want a no-code visual builder that designs and publishes a marketing site with hosting included, Framer does that end to end. design for air is design-first and agent-driven instead.' },
              ],
            },
            {
              id: 'who-picks',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from Framer into design for air',
              blocks: [
      ...
      stitch: {
        title: 'Best Google Stitch alternative for design — design for air',
        description:
          'Google Stitch is a free Gemini-powered UI generator from Google Labs, capped at ~350 standard generations/month in a hosted canvas. design for air is the open-source, local-first alternative — BYOK, no Google account, design system as files you own.',
        ...
        lead:
          'Google Stitch turns a prompt into a polished, Gemini-generated UI inside a hosted Google Labs canvas — free, but capped at ~350 standard generations a month and tied to a Google account. design for air is a local-first, open-source design agent you point your own coding agent at: same prompt-to-UI surface, but the source, the design system, and the output stay as files you own.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'Google Stitch is a free, Gemini 3-powered UI generator from Google Labs — fast first drafts, Figma paste, HTML/CSS and React export, but cloud-only, closed-source, monthly generation caps, and no enforceable design system. design for air is the open-source, local-first alternative: BYOK with your own coding agent, a portable DESIGN.md brand in your repo, and no account gating. This page is honest about where Stitch genuinely wins.',
        toc: ['Why people search', 'Local-first + BYOK', 'Feature comparison', 'Who should pick which', 'Migration / first run', 'FAQ'],
        ...
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'design for air runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your own machine — no design output is forced through a vendor cloud, and your brand lives in your repo as a portable DESIGN.md file every skill respects. There is no monthly generation cap baked into the product.',
          'You bring your own agent key — Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. Credentials stay in local config or environment variables (design for air never proxies them), model spend bills directly to your provider account, and you can drive everything from the od CLI or the local HTTP daemon, not just a web UI.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        migrateSteps: [
          'Install design for air from the download page and bring your own agent key (Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen).',
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'What are Google Stitch’s generation limits?', text: 'Stitch’s free tier runs roughly 350 standard generations per month on Gemini 2.5 Flash, plus a smaller experimental pool on Gemini 2.5 Pro (commonly reported around 50). Reports through 2026 show the cap shifting and sometimes resetting daily; either way there is no paid tier to raise it and no bring-your-own-key option. design for air has no app-level cap — you pay your own model API spend.' },
          { name: 'Is Google Stitch free?', text: 'Yes. Stitch is a free Google Labs experiment with no subscription, but it requires a Google account and the work lives in Google’s cloud. design for air is also free and open source (Apache-2.0); you bring your own agent key, so model spend bills to you with no vendor cap.' },
          { name: 'Can I self-host an alternative to Google Stitch?', text: 'Stitch is cloud-only and closed-source — there is no self-host option. design for air runs locally and self-hosts anywhere Node 24 runs, with full source on GitHub under Apache-2.0.' },
          { name: 'How does export compare?', text: 'Stitch exports HTML/CSS and React and supports paste-into-Figma (auto-layout, named layers, editable text — a real starting point, not pixel-perfect). design for air writes real files into your repo — HTML/CSS, React, decks, and a portable DESIGN.md — that you own and version directly.' },
          { name: 'Is design for air really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable. Google Stitch is a closed-source Google Labs product.' },
          { name: 'Is design for air affiliated with Google or Stitch?', text: 'No. design for air is an independent, open-source project. Google Stitch is a product of Google Labs (built on the 2025 Galileo AI acquisition); this is an unaffiliated comparison.' },
        ],
        ...
        rich: {
          heroCtaLead:
            'design for air is the open-source, local-first alternative to Google Stitch — prompt-to-UI with the coding agent you already use, your key, your files, and a portable design system you keep in your repo.',
          heroCtaActions: [
            { label: 'Download design for air', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
          heroImage: {
            ...
            alt: 'design for air vs Google Stitch — warm-paper editorial illustration of a prompt converging into a design hub you own',
          },
          intro: [
          ...
          sections: [
            ...
            {
              id: 'compare',
              heading: 'design for air vs Google Stitch, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'design for air', 'Google Stitch'], rows: [
            ...
            },
            {
              ...
              blocks: [
                ...
                { kind: 'steps', items: [
                  { label: 'You run out of generations', body: 'The ~350 standard generations a month, plus a much smaller experimental pool, sound generous until you are iterating on a real project. There is no paid tier and no bring-your-own-key escape hatch — so heavy days mean waiting for a reset. design for air has no app-level cap; you pay your own model spend and keep going.' },
                  { label: 'The brand never sticks', body: 'Stitch has no enforceable design system: you re-prompt brand colors as hex values every time, the same prompt yields a different result each run, and navigation can drift between screens. design for air centralizes brand in one DESIGN.md that every render obeys, so iterations stay consistent.' },
                  { label: 'It lives in a separate tab', body: 'Design happens in Stitch’s cloud canvas, disconnected from your repo — you export a snapshot and re-integrate by hand, with no API to wire it into CI or an agent loop. design for air output lands as files in your project and is drivable from the od CLI and local HTTP daemon.' },
                  { label: 'You cannot own or fork it', body: 'Stitch is closed-source and Google-hosted: no self-host, no audit, no rebrand for your studio. design for air is Apache-2.0 — fork it, run it on your own machine, embed it in pipelines, and own every artifact it produces.' },
                ] },
              ],
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'split', imageSide: 'left', image: { src: '/alternatives/stitch/stitch-design-systems.webp', alt: 'The design for air design-system library — brands and tokens kept as files you own', caption: 'Your design system lives as files in design for air — portable, versioned, rendered by every skill.' }, text: [
                  'design for air runs a desktop app, a local daemon, and Markdown skill and design-system catalogs <b>on your machine</b>. No design output is forced through a vendor cloud, and your brand lives in your repo as a <b>portable DESIGN.md</b> file every skill respects.',
                  'You <b>bring your own agent key</b>. Credentials stay in local config or environment variables — design for air never proxies them — and the API spend <b>bills directly to you</b>.',
                ] },
                { kind: 'p', text: 'New to the idea? Read <a href="/blog/what-is-vibe-design/">what vibe design is</a>, browse the <a href="/plugins/">plugin and design-system library</a>, see <a href="/compare/">all design for air comparisons</a> — including <a href="/alternatives/figma/">Figma</a> and <a href="/alternatives/lovable/">Lovable</a> — or <a href="/download/">download design for air</a> to try it.' },
              ],
            },
            {
              id: 'decision',
              ...
              blocks: [
                ...
                { kind: 'p', text: 'A quick way to decide by what you actually want to do — <b>most paths point to design for air</b>, but the honest exceptions are listed too:' },
                { kind: 'table', compact: true, columns: ['If you want to…', 'Best pick'], rows: [
                  ['Own your UI, code, and design system as files in git', 'design for air'],
                  ['Iterate heavily without a monthly generation cap', 'design for air'],
                  ['Enforce one brand (DESIGN.md) across every render', 'design for air'],
                  ['Run open-source you can self-host, fork, or rebrand', 'design for air'],
                  ['Drive design from your coding agent / CLI / CI (BYOK)', 'design for air'],
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from Google Stitch into design for air',
              blocks: [
          ...
          faqTitle: 'FAQ',
          faq: [
            { name: 'What are Google Stitch’s generation limits?', text: 'Stitch’s free tier runs roughly 350 standard generations per month on Gemini 2.5 Flash, plus a smaller experimental pool on Gemini 2.5 Pro (commonly reported around 50). Reports through 2026 show the cap shifting and at times resetting daily; either way there is no paid tier to raise it and no bring-your-own-key option. design for air has no app-level cap — you pay your own model API spend and keep going.' },
            { name: 'Is Google Stitch free?', text: 'Yes. Stitch is a free Google Labs experiment with no subscription, but it requires a Google account and the work lives in Google’s cloud. design for air is also free and open source (Apache-2.0); you bring your own agent key, so model spend bills to you with no vendor-set cap.' },
            { name: 'Can I self-host an alternative to Google Stitch?', text: 'Stitch is cloud-only and closed-source — there is no self-host option. design for air runs locally and self-hosts anywhere Node 24 runs, with full source on GitHub under Apache-2.0.' },
            { name: 'How does export compare?', text: 'Stitch exports HTML/CSS and React and supports paste-into-Figma (auto-layout, named layers, editable text — a real starting point, not pixel-perfect). design for air writes real files into your repo — HTML/CSS, React, decks, and a portable DESIGN.md — that you own and version directly.' },
            { name: 'Is design for air really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable. Google Stitch is a closed-source Google Labs product.' },
            { name: 'Is design for air affiliated with Google or Stitch?', text: 'No. design for air is an independent, open-source project. Google Stitch is a product of Google Labs (built on the 2025 Galileo AI acquisition); this is an unaffiliated comparison.' },
      ...
      genspark: {
        title: 'Best Genspark AI Designer alternative for design — design for air',
        description:
          'Looking for a Genspark AI Designer alternative for product design? design for air is an open-source, local-first design agent. Drive it with your own coding agent (BYOK) and own every file — UI, code, and design system — in your repo.',
        ...
        lead:
          'Genspark AI Designer (launched Aug 2025) is Genspark\'s one-prompt design product — strongest at graphic and marketing design: logos, posters, social graphics, packaging, whole brand systems. design for air is an open-source, local-first design agent for product UI: your coding agent, your key, files you own.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'Genspark AI Designer is a closed, credit-metered SaaS that excels at marketing graphics in one shot. design for air is the open-source (Apache-2.0), local-first alternative for product UI: BYOK with your own agent, a portable DESIGN.md in your repo, and output you keep as files. They do different jobs — this page is honest about where Genspark wins.',
        toc: ['Why people search', 'Local-first + BYOK', 'Feature comparison', 'Who should pick which', 'Migration / first run', 'FAQ'],
        ...
        reasons: [
          ...
          { label: 'Own the output as files.', body: 'Genspark assets live in its cloud (AI Drive) tied to an account. design for air writes UI, code and design tokens as files in your repo that you keep whether or not you keep the tool.' },
          { label: 'Open source.', body: 'Genspark is closed-source SaaS. design for air is Apache-2.0 — read it, fork it, run it locally, audit what touches your designs.' },
          { label: 'BYOK over metered credits.', body: 'Genspark meters every generation in credits (and reviewers report being charged for failed or low-quality retries). design for air runs on your own coding agent and key, so spend is just provider rates.' },
        ],
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'design for air runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine. Output lands as files in your repo, and your brand lives as a portable DESIGN.md every skill respects.',
        ...
        faq: [
          ...
          { name: 'Is design for air free?', text: 'design for air is free and open source (Apache-2.0). There is no subscription and no credit meter — you bring your own agent key, so model spend bills to your account at provider rates.' },
          { name: 'Is design for air really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable. Genspark is closed-source.' },
          { name: 'Who owns the output each produces?', text: 'With design for air you own everything — UI, code and design system are written as plain files into your own repository, no proprietary cloud format. Genspark assets live in its cloud (AI Drive) tied to your account and are exported as flattened images.' },
          { name: 'Is design for air affiliated with Genspark?', text: 'No. design for air is an independent, open-source project, not affiliated with Genspark or Mainfunc. This is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Designing product UI? Own it as files.',
        ctaBody:
          'Star the repo, grab the desktop build, or run the install in your terminal. Keep Genspark for marketing graphics — bring design for air in for the product.',
        rich: {
          heroCtaLead:
            'design for air is the open-source, local-first alternative to Genspark for product UI — your coding agent, your key, your files, and a portable design system you keep in your repo.',
          heroCtaActions: [
            { label: 'Download design for air', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
          heroImage: {
            ...
            alt: 'design for air vs Genspark — warm-paper editorial illustration of a prompt converging into a design hub you own',
          },
          intro: [
            ...
            'design for air plays a different position, so this is an honest comparison — the two tools do <b>different jobs</b>. design for air is an <b>open-source (Apache-2.0)</b>, <b>local-first</b> design agent for <b>product UI</b>: screens, flows, components and a design system, plus the code behind them. You drive it with <b>your own coding agent (BYOK)</b> and everything lands as <b>files in your repo</b>. Below we are upfront about where Genspark genuinely wins (marketing-graphic breadth, one-shot polish) and where design for air wins (open source, local-first, product UI, code you own).',
          ],
          tocLabel: 'On this page',
          toc: [
          ...
          sections: [
            ...
            },
            {
              ...
              blocks: [
                ...
                { kind: 'steps', items: [
                  ...
                  { label: 'Own the output as files', body: 'Genspark assets live in its cloud (AI Drive) tied to your account and export as flattened images. design for air writes UI, components and tokens as real files you commit to git and keep forever — the implication: no migration cost if you leave the tool.' },
                  { label: 'Open source you can audit', body: 'Genspark is closed-source SaaS; you cannot read, fork or self-host it. design for air is Apache-2.0, so security teams can audit exactly what runs against the codebase and run it on infrastructure you control.' },
                  { label: 'BYOK over a credit meter', body: 'Genspark bills generations in credits (100/day free, then 10k–125k/mo on paid plans) and reviewers report paying for failed retries. design for air runs on the coding agent and key you already have, so spend is provider rates with no per-design meter.' },
                ] },
              ],
            },
            {
              id: 'compare',
              heading: 'design for air vs Genspark AI Designer, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'design for air', 'Genspark AI Designer'], rows: [
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'split', imageSide: 'left', image: { src: '/alternatives/genspark/genspark-design-systems.webp', alt: 'The design for air design-system library — brands and tokens kept as files you own', caption: 'Your design system lives as files in design for air — portable, versioned, rendered by every skill.' }, text: [
                  ...
                  '<b>BYOK</b> means you supply the model. design for air runs on the <b>coding agent you already use</b> (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen) with <b>your own key</b>; inference bills to you at provider rates.',
                ] },
                { kind: 'p', text: 'New to the idea? Read <a href="/blog/what-is-vibe-design/">what vibe design is</a>, browse the <a href="/plugins/">plugin and design-system library</a>, see <a href="/compare/">all design for air comparisons</a> — including <a href="/alternatives/figma/">Figma</a> and <a href="/alternatives/lovable/">Lovable</a> — or <a href="/download/">download design for air</a>.' },
              ],
            },
            {
              id: 'decision',
              ...
              blocks: [
                ...
                { kind: 'table', compact: true, columns: ['If you want to…', 'Best pick'], rows: [
                  ['Design product UI plus the code and a design system', 'design for air'],
                  ['Own the output as editable files in your repo', 'design for air'],
                  ['Run an open-source design agent you can fork and audit', 'design for air'],
                  ['Keep everything local and self-hosted, no account', 'design for air'],
                  ['Bring your own coding agent and model (BYOK)', 'design for air'],
            ...
            {
              id: 'migrate',
              heading: 'Moving from Genspark to design for air',
              blocks: [
          ...
          faq: [
            ...
            { name: 'Is design for air free?', text: 'Yes — design for air is free and open source (Apache-2.0), with no subscription and no credit meter. You bring your own agent key, so model spend bills to your account at provider rates.' },
            { name: 'Is design for air really open source?', text: 'Yes — github.com/nexu-io/open-design under Apache-2.0, fully self-hostable. Genspark is closed-source.' },
            { name: 'Who owns the output each one produces?', text: 'With design for air you own everything — UI, code and design system land as plain files in your own repository. Genspark assets live in its cloud (AI Drive) tied to your account and export as flattened images.' },
            { name: 'Is design for air affiliated with Genspark?', text: 'No. design for air is an independent, open-source project, not affiliated with Genspark or Mainfunc. This is an unaffiliated comparison.' },
          ],
          ctaTitle: 'Designing product UI? Own it as files.',
          ctaBody:
            'Star the repo, grab the desktop build, or run the install in your terminal. Keep Genspark for the logo and the launch poster — bring design for air in for the product UI, the design system, and the code you own.',
          ctaActions: [
            { label: 'Download design for air', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
      ...
      'figma-make': {
        title: 'Best Figma Make alternative for design — design for air',
        description:
          'Figma Make turns prompts into React apps inside Figma\'s cloud — behind a Full seat and AI credits. design for air is the open-source, local-first, BYOK alternative.',
        breadcrumb: 'Best Figma Make alternative',
        label: 'Alternative · Figma Make',
        heading: 'Best Figma Make alternative for design.',
        lead:
          'Figma Make turns a prompt — or an existing Figma frame — into a running React app, hosted inside Figma and powered by Claude Sonnet. design for air is the open-source, local-first alternative: your coding agent, your key, output you own as files in your repo.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'Figma Make ships React apps inside Figma\'s cloud, behind a paid Full seat and AI credits that reset monthly. design for air ships product UI as files you own — open source, local-first, driven by your own agent (BYOK). For a full move off Figma the design tool, see the Figma comparison; this page is about Figma Make.',
        toc: ['Why people search', 'Local-first + BYOK', 'Feature comparison', 'Who should pick which', 'Migration / first run', 'FAQ'],
        ...
        reasons: [
          { label: 'The app lives in Figma\'s cloud, not your repo.', body: 'Make exports React/TSX, but the running app, its publish targets and Supabase wiring stay in Figma\'s runtime behind a Full seat. design for air writes UI, code, and your design system straight into your repo.' },
          { label: 'AI usage is metered and unpredictable.', body: 'Teams burn a 3,000-credit monthly allowance in a day, mostly fixing imperfect output — and undo never refunds a credit. design for air is BYOK: pay your provider directly, no credit ledger.' },
          { label: 'Authoring needs a paid Full seat.', body: 'A View or Dev seat can\'t build in Make — you need a Full seat (~$16–$90/user/mo) on top of credits. design for air is Apache-2.0 and free to run.' },
          { label: 'Closed-source and cloud-only.', body: 'No self-host, no local mode, no on-premise option. design for air is open source and local-first — it runs on your machine and you can audit it.' },
        ],
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          ...
          'BYOK means design for air runs on the coding agent you already use (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen) with your own key — you own the output and the engine driving it.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        migrateTitle: 'Migration / first run',
        migrateLead: 'Moving a Figma Make prototype toward an design for air workflow:',
        migrateSteps: [
          'Install your coding agent (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen) and add your own key — no Figma seat, no credits.',
          'Point design for air at your repo; it runs locally and writes UI and code where your build and CI already are.',
        ...
        migrateClosing:
          'For a broader move off Figma the design tool, see the design for air vs Figma comparison; this page is about Figma Make specifically.',
        faqTitle: 'FAQ',
        faq: [
          { name: 'How much does Figma Make cost?', text: 'Authoring requires a paid Figma Full seat (~$16/user/mo on Professional up to $90 on Enterprise) plus AI credits metered per action. Credit allowances run 500/mo (Starter) to 4,250/mo (Enterprise), reset monthly, no rollover; a full app generation can cost 100+ credits. design for air is free to run — you only pay your own model provider via your key.' },
          { name: 'Can I self-host Figma Make or run it locally?', text: 'No. Figma Make runs exclusively inside Figma\'s hosted cloud — no local mode, self-host, or on-premise option. design for air is local-first and runs entirely on your machine.' },
          { name: 'Do I need a paid Figma seat to use Figma Make?', text: 'Yes. Authoring in Make requires a paid Full seat; Dev and Collab seats get trial access only and a View seat can\'t author. design for air needs no account or seat — clone the repo and run it with your own coding agent.' },
          { name: 'Can I export the code Figma Make generates?', text: 'Yes — download the React/TypeScript app as a ZIP or push it to a GitHub repo. The caveat: the export is source, not a turnkey deploy, and the running app and Supabase wiring stay tied to Figma\'s runtime. With design for air the output is files in your repo from the start.' },
          { name: 'Is design for air open source?', text: 'Yes — Apache-2.0, local-first, BYOK with your own coding agent (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen) and your own model key. Figma Make is proprietary and closed-source.' },
          { name: 'Is design for air affiliated with Figma?', text: 'No. design for air is an independent, open-source project, not affiliated with or endorsed by Figma. Figma and Figma Make are trademarks of Figma, Inc.; this is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Own your output — from prompt to repo.',
        ctaBody:
          'Figma Make is the fastest path from a Figma frame to a hosted prototype — if you author behind a Full seat, spend AI credits, and keep the running app in Figma\'s cloud. design for air takes the other path: open source, local-first, your own agent and key, every generation a file you own.',
        rich: {
          heroCtaLead:
            'design for air is the open-source, local-first alternative to Figma Make — your coding agent, your key, your files, and a portable design system you keep in your repo, with no Figma cloud lock-in and no credit meter.',
          heroCtaActions: [
            { label: 'Download design for air', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
          heroImage: {
            ...
            alt: 'design for air vs Figma Make — warm-paper editorial illustration of a prompt converging into a design hub you own',
          },
          intro: [
          ...
          sections: [
            ...
            {
              id: 'compare',
              heading: 'design for air vs Figma Make, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'design for air', 'Figma Make'], rows: [
            ...
            },
            {
              ...
              blocks: [
                ...
                { kind: 'steps', items: [
                  { label: 'The app lives in Figma\'s cloud, not your repo', body: 'Make can hand you a React/TSX ZIP, but the running app — its preview, publish targets, Supabase wiring — lives in Figma\'s runtime behind a Full seat. The export gives you source, not a turnkey deploy; reviewers flag excessive div nesting, thin error handling, and architecture that needs substantial rebuilding. In design for air the output is the artifact — UI, components, and design system land as files in your own repo, already where your build and CI live.' },
                  { label: 'AI usage is metered, and the meter is unpredictable', body: 'The loudest complaint on Figma\'s own forum is credits: teams burn a full 3,000-credit monthly allowance in a day across ~100 prompts, and most of those go to fixing imperfect output — exactly the iteration the tool depends on. Undo reverts your file but never refunds the credit, and you can\'t predict the cap before you hit it. design for air is BYOK: bring your own model key and pay your provider directly, so iteration cost is transparent and uncapped.' },
                  { label: 'Authoring is gated behind a paid Full seat', body: 'A View or Dev seat won\'t let you build in Make — you need a paid Full seat (~$16–$90/user/month) just to author, on top of credits. For a team where engineers, PMs, or contractors want to generate UI, that\'s a per-head paywall before anyone writes a prompt. design for air is Apache-2.0 and free to run; anyone with a repo checkout can drive it.' },
                  { label: 'It\'s closed-source and cloud-only by design', body: 'Make runs exclusively in Figma\'s hosted cloud — there is no self-host, no local mode, and no on-premise option, a hard stop for teams with code-can\'t-leave-the-building policies or air-gapped requirements. design for air is open source and local-first: it runs on your machine, your code never has to touch a third-party runtime, and you can audit exactly what the agent does.' },
                ] },
              ],
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'split', imageSide: 'left', image: { src: '/alternatives/figma-make/figma-make-design-systems.webp', alt: 'The design for air design-system library — brands and tokens kept as files you own', caption: 'Your design system lives as files in design for air — portable, versioned, rendered by every skill.' }, text: [
                  ...
                  '<b>BYOK</b> means you point design for air at the <b>coding agent you already trust</b> (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen) with <b>your own key</b>. You pick the model, pay your provider directly, and own both the output and the engine driving it — no credit meter in between.',
                ] },
                { kind: 'p', text: 'New to the idea? Read <a href="/blog/what-is-vibe-design/">what vibe design is</a>, browse the <a href="/plugins/">plugin and design-system library</a>, see <a href="/compare/">all design for air comparisons</a> — including <a href="/alternatives/figma/">Figma</a> and <a href="/alternatives/lovable/">Lovable</a> — or <a href="/download/">download design for air</a>.' },
              ],
            },
            {
              ...
              blocks: [
                ...
                { kind: 'table', compact: true, columns: ['If you want…', 'Best pick'], rows: [
                  ['Output as files in your own repo, owned outright', 'design for air'],
                  ['Open-source, auditable, self-hostable / local', 'design for air'],
                  ['No per-seat paywall and no AI credit cap', 'design for air'],
                  ['Freedom to use any model and any coding agent (BYOK)', 'design for air'],
            ...
            {
              id: 'migrate',
              heading: 'Moving from Figma Make to design for air',
              blocks: [
                { kind: 'p', text: 'Getting from a Figma Make prototype to an design for air workflow:' },
                { kind: 'ol', items: [
                  ...
                  'Point design for air at your repo; it runs locally and writes generated UI, components, and code where your build and CI already are.',
                ...
                { kind: 'p', text: 'For a broader move off Figma the design tool, see <a href="/alternatives/figma/">the design for air vs Figma comparison</a>.' },
              ],
            },
          ],
          faqTitle: 'FAQ',
          ...
          ctaTitle: 'Own your output — from prompt to repo.',
          ctaBody:
            'Figma Make is the fastest path from a Figma frame to a hosted prototype — if you author behind a Full seat, spend AI credits, and keep the running app in Figma\'s cloud. design for air takes the other path: open source, local-first, drive it with the coding agent and key you already have, and every generation lands as files you own in your own repo.',
          ctaActions: [
            { label: 'Download design for air', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
      ...
      qoder: {
        title: 'Best QoderWork Design alternative for design — design for air',
        description:
          'Looking for a QoderWork Design alternative? design for air is the open-source, local-first design agent: drive it with your own coding agent, own every file it writes, no IDE or vendor lock-in.',
        ...
        lead:
          'QoderWork Design and design for air agree on the big idea — design-as-code, prompt-to-UI, editable output. They diverge on everything around it: design for air is open source, local-first, and runs on your own agent (BYOK); Qoder is closed-source and bound to Alibaba\'s IDE and models.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'Qoder is one of the closest products in spirit to design for air — both do design-as-code. The difference is openness: design for air is Apache-2.0, local-first, and BYOK with your own coding agent; Qoder is closed-source and built around Qoder IDE. It is honest about where Qoder wins.',
        toc: ['Why people search', 'Local-first + BYOK', 'Feature comparison', 'Who should pick which', 'Migration / first run', 'FAQ'],
        ...
        reasons: [
          { label: 'You want open source.', body: 'Qoder is closed-source, built by Alibaba. design for air is Apache-2.0 — read, self-host, fork, audit.' },
          { label: 'You want BYOK and agent choice.', body: 'Qoder runs its own models inside its product; design for air runs on the coding agent you already use, with your keys.' },
          { label: 'You don\'t want IDE lock-in.', body: 'Qoder\'s smoothest path runs through Qoder IDE; design for air works alongside whatever you already have.' },
          { label: 'You want to truly own output.', body: 'With design for air the deliverable is files in your repo — committed, versioned, yours from the first keystroke.' },
        ],
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'Local-first means your design work lives where your code lives: real source — components, styles, a portable DESIGN.md every skill follows — written into your repo, versioned in git, usable even if you stop using design for air.',
          'BYOK means design for air ships no model and charges no inference. You point it at the agent and key you already have (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen); you choose the model and see the cost.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        migrateTitle: 'Migration / first run',
        migrateLead: 'Moving from Qoder to design for air — since both speak code, your existing output is the starting point:',
        migrateSteps: [
          ...
          'Point design for air at the coding agent you already use with your own key.',
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'design for air and Qoder look really similar — what\'s the difference?', text: 'They are close: both do prompt-to-UI, design-as-code, editable output. The difference is everything around generation. design for air is open source (Apache-2.0), local-first, and BYOK with your own agent, output in your repo. Qoder is closed-source, built around Alibaba\'s models and Qoder IDE.' },
          { name: 'Is design for air really open source?', text: 'Yes — Apache-2.0. Read the source, self-host, fork, audit. QoderWork Design is closed-source.' },
          { name: 'Which AI agent do I use with design for air?', text: 'Whichever you already have — Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen, via BYOK with your own keys.' },
          { name: 'Does Qoder also keep my work local?', text: 'Partly — it can pin a project to a local folder and hand off to Qoder IDE. But the primary surface is a hosted canvas. In design for air, the repo itself is the product.' },
          { name: 'Does design for air have an interactive canvas?', text: 'No — a deliberate trade. Qoder\'s canvas with marquee-select and Nudge is excellent for visual editing. design for air is code- and file-driven through your coding agent.' },
          { name: 'Is design for air affiliated with Qoder or Alibaba?', text: 'No. design for air is an independent, open-source project, not affiliated with Qoder or Alibaba. This is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Own your design workflow — end to end.',
        ctaBody:
          'design for air runs on the coding agent you already use and writes files you actually own. No lock-in, no second subscription, no canvas you can\'t leave.',
        rich: {
          heroCtaLead:
            'design for air is the open-source, local-first alternative to QoderWork Design — the same design-as-code idea, but Apache-2.0, BYOK with your own coding agent, and output that lives in your repo and belongs to you.',
          heroCtaActions: [
            { label: 'Download design for air', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
          heroImage: {
            ...
            alt: 'design for air vs Qoder — warm-paper editorial illustration of a prompt converging into a design hub you own',
          },
          intro: [
            'Of every tool in this comparison series, QoderWork Design is the closest to design for air in spirit. Built by the Qoder team at Alibaba (<a href="https://qoder.com" target="_blank" rel="noopener">qoder.com</a>), it bills itself as <b>"AI-native design as code"</b>: you describe what you want, it renders a real, runnable design on an infinite canvas, you clarify intent through <b>Questions</b>, preview a structured <b>Design Plan</b> before it builds, and then <b>Nudge</b> color, spacing and radius after the fact. The output is genuine front-end code — HTML or React on shadcn/ui, Spark Design or Ant Design — not a flattened vector mock. That is a real product with a polished loop, and it deserves the credit.',
            'Because the two tools share a thesis — prompt to UI, design as <i>code</i>, editable output you can ship — the honest comparison is not about who generates nicer screens. It is about everything <i>around</i> generation. design for air is <b>Apache-2.0</b>, <b>local-first</b>, and <b>BYOK</b>: it ships no model, runs on the coding agent you already pay for, and writes its output straight into your repository. QoderWork Design is <b>closed-source</b>, runs on <b>Qoder\'s own (undisclosed) models</b> behind a credit meter, and is at its best inside Alibaba\'s own IDE. If you want the most polished integrated canvas, Qoder is excellent. If you want openness, your own agent, and a workflow that is not bet on a single vendor, that is the gap design for air fills.',
          ],
          tocLabel: 'On this page',
          toc: [
          ...
          sections: [
            ...
            },
            {
              ...
              blocks: [
                ...
                { kind: 'steps', items: [
                  { label: 'You want open source', body: 'Qoder is closed-source and built by Alibaba — you cannot read how it works, self-host it, or fork it if priorities change. design for air is Apache-2.0: the entire agent, skill library and renderer are on GitHub to read, audit, run on your own machine, and fork. For anyone with a security-review or supply-chain requirement, "we can read the code" is not a nice-to-have.' },
                  { label: 'You want BYOK and agent choice', body: 'QoderWork Design runs on Qoder\'s own models — which it does not publicly name — and meters them in credits you buy from Alibaba. design for air ships no model and resells no inference. You point it at the coding agent and key you already pay for (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen), pick the model, and see the real cost — no second subscription, no opaque per-credit pricing.' },
                  { label: 'You don\'t want IDE or vendor lock-in', body: 'Qoder\'s smoothest path runs through the standalone Qoder IDE and the broader Alibaba ecosystem; the one-click handoff is great precisely because it assumes you live there. design for air is just files in a repo, so it works alongside VS Code, JetBrains, Neovim, your CI, and your existing review process — nothing has to route through one editor.' },
                  { label: 'You want to truly own the output', body: 'In design for air the deliverable is real source committed to your repository — components, styles, and a portable DESIGN.md — versioned in git and fully usable even if you stop using design for air tomorrow. Qoder can pin to a local folder, but the product surface is a hosted canvas you have to stay inside; the files are a sync target downstream of it, not the source of truth.' },
                ] },
              ],
            },
            {
              id: 'compare',
              heading: 'design for air vs QoderWork Design, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'design for air', 'QoderWork Design'], rows: [
            ...
            },
            {
              ...
              blocks: [
                ...
                { kind: 'table', compact: true, columns: ['If you care most about…', 'Lean toward'], rows: [
                  ['Open source you can read, audit, fork, and self-host', 'design for air'],
                  ['Using your own coding agent and keys (BYOK)', 'design for air'],
                  ['Output that lives and stays in your own repo', 'design for air'],
                  ['Freedom from any one IDE, vendor, or ecosystem', 'design for air'],
                  ['No credit meter — you pay only your own agent', 'design for air'],
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'split', imageSide: 'left', image: { src: '/alternatives/qoder/qoder-design-systems.webp', alt: 'The design for air design-system library — brands and tokens kept as files you own', caption: 'Your design system lives as files in design for air — portable, versioned, rendered by every skill.' }, text: [
                  '<b>Local-first</b> means your design work lives as <b>files in your own repo</b>: real source and a portable <b>DESIGN.md</b> that every skill obeys, versioned in git, reviewable in pull requests, and fully usable even if you stopped using design for air tomorrow. QoderWork Design can pin a project to a local folder and hand it to Qoder IDE — real and useful — but the product surface is still the hosted canvas, and the local files are a sync target downstream of it. In design for air the repo <i>is</i> the surface; there is no canvas you have to stay inside.',
                  '<b>BYOK</b> means design for air ships no model and charges no inference. Point it at <b>your own agent and key</b> — Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — pick the model, and pay your provider directly. No credits to top up, no opaque per-task burn, and you upgrade to a better model the day it ships instead of waiting for a vendor to wire it in.',
                ] },
                { kind: 'p', text: 'New to the idea? Read <a href="/blog/what-is-vibe-design/">what vibe design is</a>, browse the <a href="/plugins/">plugin and design-system library</a>, see <a href="/compare/">all design for air comparisons</a> — including <a href="/alternatives/figma/">Figma</a>, <a href="/alternatives/lovable/">Lovable</a>, and <a href="/alternatives/v0/">v0</a> — or <a href="/download/">download design for air</a>.' },
              ],
            },
            {
              id: 'migrate',
              ...
              blocks: [
                ...
                { kind: 'ol', items: [
                  ...
                  'Capture your design language — colors, spacing, radii, type scale, components — once in a portable DESIGN.md that every design for air skill will follow.',
                  'Point design for air at the coding agent you already use, authenticated with your own key (BYOK); nothing routes through design for air\'s servers.',
          ...
          faqTitle: 'FAQ',
          faq: [
            { name: 'QoderWork Design and design for air both do design-as-code — how are they actually different?', text: 'They are the closest peers in this comparison: both turn a prompt into runnable, editable UI code rather than a flattened mock. The difference is everything around generation. design for air is open source (Apache-2.0), local-first, and BYOK — it runs on the coding agent you already pay for and writes output straight into your repo. QoderWork Design is closed-source, runs on Qoder\'s own undisclosed models behind a credit meter, and is at its best inside Alibaba\'s Qoder IDE. Same idea; opposite stances on openness and ownership.' },
            { name: 'Is design for air really open source?', text: 'Yes — Apache-2.0. The whole thing — the agent, the skill and design-system library, and the renderer — is on GitHub to read, self-host, fork, and audit. QoderWork Design is closed-source.' },
            { name: 'Which AI agent and model does design for air use?', text: 'Whichever you already have. design for air is BYOK and ships no model of its own: Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen, with your own keys, and you choose the underlying model. QoderWork Design instead runs on Qoder\'s own models, which it does not publicly name, metered in credits.' },
            { name: 'Does QoderWork Design also keep my work local?', text: 'Partly. It can pin a project to a local folder and hand off to the Qoder IDE in one click, which is genuinely useful. But the primary working surface is a hosted canvas, so the local files are a sync target downstream of it. In design for air the repo itself is the product — there is no hosted canvas in the loop.' },
            { name: 'Will my workflow be locked into Qoder IDE or the Alibaba ecosystem?', text: 'With QoderWork Design the smoothest path assumes you do — the one-click handoff lands in Qoder IDE, and the experience is tuned for the Qoder/Alibaba stack. design for air has no IDE lock-in: output is just files in a repo, so it works alongside VS Code, JetBrains, Neovim, your CI, and your existing review process.' },
            { name: 'How much does each cost?', text: 'design for air is free and open source; the only thing you pay for is your own coding agent (BYOK), so there is no separate seat or credit charge. Qoder is credit-based — Pro is roughly $30/month for around 2,000 credits, Pro+ about $60, and Ultra about $200, with extra credits sold per-credit; credit-heavy tasks can burn a Pro plan in days. Check qoder.com for current numbers.' },
            { name: 'Is design for air affiliated with Qoder or Alibaba?', text: 'No. design for air is an independent, open-source project and is not affiliated with, endorsed by, or sponsored by Qoder or Alibaba. Qoder and QoderWork are trademarks of their respective owners. This is an unaffiliated comparison.' },
          ],
          ctaTitle: 'Own your design workflow — end to end.',
          ctaBody:
            'design for air runs on the coding agent you already use and writes files you actually own. No closed vendor, no credit meter, no canvas you can\'t leave.',
          ctaActions: [
            { label: 'Download design for air', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
      ...
      trae: {
        title: 'Best Trae alternative for design — design for air',
        description:
          'Looking for a Trae alternative for design? design for air is an open-source, local-first design agent that runs on your own coding agent and keeps your design system as files you own. Many teams run both.',
        breadcrumb: 'Best Trae alternative',
        label: 'Alternative · Trae',
        heading: 'Best Trae alternative for design.',
        lead:
          'Trae is ByteDance\'s free, VS Code–based AI IDE — strong at turning screenshots and Figma frames into UI, and at SOLO full-stack generation. design for air is a design-first agent that owns your design system as portable files — they sit at different layers, and many teams run both.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'Trae is ByteDance\'s free, VS Code–based AI IDE; design-to-code (screenshot/Figma → React/Tailwind) and SOLO full-stack generation are features inside it. design for air is design-first: it owns your design system (DESIGN.md) as files, is open source (Apache-2.0) and local-first, and runs on the coding agent you already use. They are complementary — Trae writes code, design for air governs the design system.',
        ...
        reasons: [
          ...
          { label: 'Open source.', body: 'Trae is closed-source; design for air is Apache-2.0 — read, fork, run it locally.' },
          { label: 'Agent freedom + BYOK.', body: 'Drive it with the coding agent you already use, with your own key — not one bundled model.' },
        ],
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'Local-first means the work product lives with you: a portable DESIGN.md plus the design artifacts design for air generates, committed to your repo, reviewable in pull requests, yours to keep.',
          'BYOK means design for air doesn\'t ship its own model. Point it at the coding agent you already trust (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen) with your own key — you control the model, cost, and data path.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        migrateLead: 'For many teams the answer is both — Trae writes and ships the code, design for air owns the design system that feeds it:',
        migrateSteps: [
          'Keep Trae as your IDE for writing, refactoring, and shipping code (including SOLO and design-to-code).',
          'Add design for air as your design layer; point it at your coding agent with your own key.',
          'Make DESIGN.md the source of truth — every design for air skill follows it.',
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'Isn\'t Trae an IDE? What\'s its relationship to design for air?', text: 'Yes — Trae is an AI-native IDE (a code editor forked from the VS Code core) from ByteDance, and design-to-code is a feature inside it. design for air is a design-first agent that owns your design system as files. They are complementary and sit at different layers, not direct competitors.' },
          { name: 'Can I use Trae and design for air together?', text: 'Yes, and many teams do. Trae writes and ships code (including SOLO and design-to-code); design for air owns the design system (DESIGN.md) the code consumes. design for air produces files in your repo, so any IDE — Trae included — picks them up.' },
          { name: 'Is Trae free? How does its pricing work?', text: 'Trae has a free tier (around 5,000 autocompletions/month and limited premium-model requests) plus paid tiers — as of early 2026 roughly Lite $3, Pro $10, Pro+ $30, and Ultra $100 per month — on a token-based Basic+Bonus usage model. design for air is free and open-source; you pay only for your own model usage via BYOK.' },
          { name: 'Is design for air open source?', text: 'Yes — Apache-2.0. Read it, fork it, self-host it, run it locally. Trae is closed-source and hosted.' },
          { name: 'Which AI agent or model does design for air use?', text: 'Whichever you choose — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen, using your own key. Trae instead bundles models (Claude Sonnet, GPT-4o, Gemini 2.5 Pro, DeepSeek, and ByteDance\'s own) that you switch between in-product.' },
          { name: 'Is design for air affiliated with Trae or ByteDance?', text: 'No. design for air is an independent, open-source project, not affiliated with Trae or ByteDance. Trae is a ByteDance product and trademark. This is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Own your design system, on your own terms.',
        ctaBody:
          'design for air is the open-source, local-first design agent that runs on the coding agent you already use — and pairs cleanly with an IDE like Trae. Keep your design system as portable files you control.',
        rich: {
          heroCtaLead:
            'design for air is the open-source, local-first, design-first alternative to Trae for design — it owns your design system as portable files, runs on your own coding agent (BYOK), and pairs cleanly with the IDE you already use.',
          heroCtaActions: [
            { label: 'Download design for air', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
          ...
          sections: [
            ...
            {
              id: 'compare',
              heading: 'design for air vs Trae, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'design for air', 'Trae'], rows: [
                ...
                { kind: 'p', text: 'Where Trae wins: for several jobs it is the better pick and it is not close. It is a complete, polished AI IDE — if you want one environment to write and ship code, Trae does that and design for air does not. Its design-to-code is first-class, SOLO\'s end-to-end full-stack generation has no equivalent in design for air, and it is free to start. If those are your core needs, choose Trae. design for air instead owns the design system as <b>files you own</b> — <b>open-source</b>, <b>local-first</b>, driven by <b>your own coding agent</b>.' },
              ],
            },
            {
              id: 'why-switch',
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'split', imageSide: 'left', image: { src: '/alternatives/trae/trae-design-systems.webp', alt: 'The design for air design-system library — brands and tokens kept as files you own', caption: 'Your design system lives as files in design for air — portable, versioned, rendered by every skill.' }, text: [
                  '<b>Local-first</b> means the work product lives with you, not in someone else\'s cloud. design for air produces a portable <b>DESIGN.md</b> plus design artifacts directly in <b>your repository</b> — committed alongside your code, reviewable in pull requests, yours even if you stop using the tool.',
                  '<b>BYOK</b> means design for air doesn\'t ship or lock you into a model. Point it at the <b>coding agent you already trust</b> (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen) with <b>your own key</b>.',
                ] },
                { kind: 'p', text: 'New to the idea? Read <a href="/blog/what-is-vibe-design/">what vibe design is</a>, browse the <a href="/plugins/">plugin and design-system library</a>, see <a href="/compare/">all design for air comparisons</a> — including <a href="/alternatives/figma/">Figma</a> and <a href="/alternatives/lovable/">Lovable</a> — or <a href="/download/">download design for air</a>.' },
              ],
            },
            {
              ...
              blocks: [
                ...
                { kind: 'table', compact: true, columns: ['If you want…', 'Pick'], rows: [
                  ['A design-first workflow, not a code editor', 'design for air'],
                  ['To own your design system as files (DESIGN.md)', 'design for air'],
                  ['Open source you can self-host and fork', 'design for air'],
                  ['To bring your own coding agent and key (BYOK)', 'design for air'],
                ...
                { kind: 'p', text: 'Most teams find these rows are not in conflict: Trae owns the rows about writing and shipping code, design for air owns the rows about the design system itself. That is exactly why so many run both.' },
              ],
            },
            {
              id: 'migrate',
              heading: 'Using Trae and design for air together',
              blocks: [
                { kind: 'p', text: 'A common setup runs both — Trae as the IDE, design for air as the design layer:' },
                { kind: 'ol', items: [
                  'Keep Trae for writing, refactoring, and shipping code (including SOLO and design-to-code).',
                  'Add design for air; point it at the coding agent you already use with your own key.',
                  'Make DESIGN.md the source of truth — every design for air skill follows it.',
                  'Loop them: reconcile Trae\'s UI against your design system; commit design-system changes as files Trae picks up.',
                ] },
      ...
      'claude-design': {
        title: 'Open-source Claude Design alternative — design for air (BYOK, local-first)',
        description:
          'design for air is the open-source, local-first alternative to Claude Design. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — your skills and DESIGN.md live in your repo.',
        breadcrumb: 'Open-source Claude Design alternative',
        label: 'Alternative · Claude Design',
        heading: 'Open-source Claude Design alternative.',
        lead:
          'design for air is the open-source, local-first alternative to Claude Design. Same use case — prompt to design artifact — different posture: BYOK with the agent you already use, keep your brand as a portable DESIGN.md file, and ship artifacts as files in your project.',
        tldrTitle: 'TL;DR',
        tldrBody:
        ...
        faq: [
          { name: 'Is design for air really a drop-in alternative to Claude Design?', text: 'Not literally, but they overlap on prompt-to-design-artifact use cases.' },
          { name: 'Can I use Claude as my agent in design for air?', text: 'Yes. design for air supports Claude Code and Anthropic API BYOK flows; credentials are never proxied through us.' },
          { name: 'What happens to my Claude Design designs?', text: 'You can keep using Claude Design alongside design for air; migration is manual today.' },
          { name: 'Does design for air generate the same artifact types?', text: 'Yes for common types: landing pages, decks, dashboards, social posts, brand systems, and prototypes.' },
          { name: 'Is design for air really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
          { name: 'Is design for air affiliated with Anthropic or Claude?', text: 'No. design for air is an independent, open-source project. Claude is a trademark of Anthropic; this is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Switch in three commands.',
        ctaBody:
          'Star the repo, grab the desktop build, or run the install in your terminal. Your DESIGN.md system stays in your repo from the first render onward.',
        rich: {
          ...
          heroImage: {
            ...
            alt: 'design for air vs Claude Design — warm-paper editorial illustration of code converging into a design hub',
          },
          intro: [
            'Claude Design is a hosted, vendor-managed product for prompt-to-design work. design for air is a self-evolving design agent for Claude Code and other coding agents — local-first, BYOK, Apache-2.0 — that keeps your skills and a portable brand as files in your own repo.',
          ...
          sections: [
            {
              ...
              blocks: [
                ...
                { kind: 'p', text: 'design for air is a different posture: a local-first, open-source design agent you point your own coding agent at — overlapping on the prompt-to-design-artifact job, not on being a hosted product.' },
                { kind: 'ul', items: [
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'p', text: 'design for air runs a desktop app, a local daemon, and Markdown skill/system catalogs on your machine. No design output is forced through a vendor cloud, and your brand lives in your repo as a portable DESIGN.md file every skill respects.' },
                { kind: 'p', text: 'You bring your own agent key. Credentials stay in local config or environment variables — design for air never proxies them — and the API spend bills directly to you.' },
              ],
            },
            {
              id: 'compare',
              heading: 'design for air vs Claude Design, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'design for air', 'Claude Design'], rows: [
                  ['License', 'Apache-2.0, full source on GitHub', 'Closed-source, hosted product'],
                  ['Runtime', 'Local daemon on your machine', 'Vendor cloud'],
                ...
                { kind: 'p', text: 'Where Claude Design wins: zero local setup, one vendor bill, and a hosted UI. If that convenience is the priority, a hosted product is hard to beat — design for air trades it for ownership, BYOK, and open source.' },
              ],
            },
            {
              id: 'who-picks',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from Claude Design into design for air',
              blocks: [
    ...
    download: {
      title: 'Download design for air — desktop app for macOS, Windows & Linux',
      description:
        'Download the latest design for air desktop build. Install and create — sign in once, pick a model, start designing. macOS (Apple Silicon & Intel), Windows, and Linux.',
      breadcrumb: 'Download',
      label: 'Download',
      heading: 'Download design for air.',
      lead:
      ...
      autoCtaFallback: 'Download design for air',
      ...
      ctaBody:
        'Install from source in three commands, or drive design for air headlessly from your existing coding agent.',
    },
  },
};
...
const COMPACT_DOWNLOAD_COPY: Partial<Record<LandingLocaleCode, DownloadCopy>> = {
  ja: {
    ...
    title: 'design for air をダウンロード — macOS / Windows / Linux デスクトップアプリ',
    description:
      '最新の design for air デスクトップ版をダウンロード。入れたらすぐ作れます——一度サインインし、モデルを選んで、デザインを開始。macOS（Apple Silicon と Intel）、Windows、Linux に対応。',
    breadcrumb: 'ダウンロード',
    label: 'ダウンロード',
    heading: 'design for air をダウンロード。',
    lead:
      '入れたらすぐ作れます——API キー不要、設定不要。デスクトップ版は公式モデルルーター内蔵。一度サインインすればデザインを始められます。',
    autoCtaPrefix: 'ダウンロード:',
    autoCtaFallback: 'design for air をダウンロード',
    recommended: 'おすすめ',
    publishedPrefix: '公開日',
    ...
    ctaTitle: 'ターミナル派ですか？',
    ctaBody:
      '3 つのコマンドでソースからインストール、または既存のコーディングエージェントから design for air をヘッドレスで動かせます。',
  },
  ko: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'design for air 다운로드 — macOS / Windows / Linux 데스크톱 앱',
    description:
      '최신 design for air 데스크톱 빌드를 다운로드하세요. 설치하면 바로 제작——한 번 로그인하고 모델을 고른 뒤 디자인을 시작하세요. macOS(Apple Silicon 및 Intel), Windows, Linux 지원.',
    breadcrumb: '다운로드',
    label: '다운로드',
    heading: 'design for air 다운로드.',
    lead:
      '설치하면 바로 제작——API 키도, 설정도 필요 없습니다. 데스크톱 앱에는 공식 모델 라우터가 내장되어 있어 한 번 로그인하면 바로 디자인할 수 있습니다.',
    autoCtaPrefix: '다운로드 대상:',
    autoCtaFallback: 'design for air 다운로드',
    recommended: '추천',
    publishedPrefix: '출시일',
    releaseNotes: '릴리스 노트',
    ...
    ctaBody:
      '세 개의 명령으로 소스에서 설치하거나, 기존 코딩 에이전트에서 design for air을 헤드리스로 구동하세요.',
  },
  de: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'design for air herunterladen — Desktop-App für macOS, Windows & Linux',
    description:
    ...
    breadcrumb: 'Download',
    label: 'Download',
    heading: 'design for air herunterladen.',
    lead:
    ...
    autoCtaFallback: 'design for air herunterladen',
    ...
    ctaBody:
      'Installiere aus dem Quellcode mit drei Befehlen oder steuere design for air headless aus deinem bestehenden Coding-Agent.',
  },
  fr: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Télécharger design for air — application de bureau pour macOS, Windows et Linux',
    description:
      'Téléchargez la dernière version bureau d’design for air. Installez et créez — connectez-vous une fois, choisissez un modèle, commencez à concevoir. macOS (Apple Silicon et Intel), Windows et Linux.',
    breadcrumb: 'Télécharger',
    label: 'Télécharger',
    heading: 'Télécharger design for air.',
    lead:
    ...
    autoCtaFallback: 'Télécharger design for air',
    ...
    ctaBody:
      'Installez depuis les sources en trois commandes, ou pilotez design for air en mode headless depuis votre agent de code existant.',
  },
  ru: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Скачать design for air — десктопное приложение для macOS, Windows и Linux',
    description:
      'Скачайте последнюю десктопную сборку design for air. Установите и создавайте — войдите один раз, выберите модель, начните проектировать. macOS (Apple Silicon и Intel), Windows и Linux.',
    breadcrumb: 'Скачать',
    label: 'Скачать',
    heading: 'Скачать design for air.',
    lead:
    ...
    autoCtaFallback: 'Скачать design for air',
    ...
    ctaBody:
      'Установите из исходников тремя командами или управляйте design for air в headless-режиме из вашего существующего агента для кода.',
  },
  es: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Descargar design for air — app de escritorio para macOS, Windows y Linux',
    description:
      'Descarga la última versión de escritorio de design for air. Instala y crea: inicia sesión una vez, elige un modelo y empieza a diseñar. macOS (Apple Silicon e Intel), Windows y Linux.',
    breadcrumb: 'Descargar',
    label: 'Descargar',
    heading: 'Descargar design for air.',
    lead:
    ...
    autoCtaFallback: 'Descargar design for air',
    ...
    ctaBody:
      'Instala desde el código fuente con tres comandos, o controla design for air en modo headless desde tu agente de código actual.',
  },
  'pt-br': {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Baixar design for air — app de desktop para macOS, Windows e Linux',
    description:
      'Baixe a versão de desktop mais recente do design for air. Instale e crie: faça login uma vez, escolha um modelo e comece a projetar. macOS (Apple Silicon e Intel), Windows e Linux.',
    breadcrumb: 'Baixar',
    label: 'Baixar',
    heading: 'Baixar design for air.',
    lead:
    ...
    autoCtaFallback: 'Baixar design for air',
    recommended: 'Recomendado',
    ...
    ctaBody:
      'Instale a partir do código-fonte com três comandos, ou controle o design for air em modo headless pelo seu agente de código atual.',
  },
  it: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Scarica design for air — app desktop per macOS, Windows e Linux',
    description:
      'Scarica l’ultima build desktop di design for air. Installa e crea: accedi una volta, scegli un modello e inizia a progettare. macOS (Apple Silicon e Intel), Windows e Linux.',
    breadcrumb: 'Scarica',
    label: 'Scarica',
    heading: 'Scarica design for air.',
    lead:
    ...
    autoCtaFallback: 'Scarica design for air',
    ...
    ctaBody:
      'Installa dai sorgenti con tre comandi, oppure pilota design for air in modalità headless dal tuo agente di coding esistente.',
  },
  vi: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Tải design for air — ứng dụng máy tính cho macOS, Windows và Linux',
    description:
      'Tải bản dựng máy tính design for air mới nhất. Cài đặt là tạo được ngay — đăng nhập một lần, chọn mô hình và bắt đầu thiết kế. macOS (Apple Silicon và Intel), Windows và Linux.',
    breadcrumb: 'Tải xuống',
    label: 'Tải xuống',
    heading: 'Tải design for air.',
    lead:
    ...
    autoCtaFallback: 'Tải design for air',
    ...
    ctaBody:
      'Cài đặt từ mã nguồn bằng ba lệnh, hoặc điều khiển design for air ở chế độ headless từ agent lập trình hiện có của bạn.',
  },
  pl: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Pobierz design for air — aplikacja desktopowa na macOS, Windows i Linux',
    description:
      'Pobierz najnowszą wersję desktopową design for air. Zainstaluj i twórz — zaloguj się raz, wybierz model i zacznij projektować. macOS (Apple Silicon i Intel), Windows oraz Linux.',
    breadcrumb: 'Pobierz',
    label: 'Pobierz',
    heading: 'Pobierz design for air.',
    lead:
    ...
    autoCtaFallback: 'Pobierz design for air',
    ...
    ctaBody:
      'Zainstaluj ze źródeł trzema poleceniami albo steruj design for air w trybie headless ze swojego agenta do kodowania.',
  },
  id: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Unduh design for air — aplikasi desktop untuk macOS, Windows & Linux',
    description:
      'Unduh build desktop design for air terbaru. Pasang lalu berkarya — masuk sekali, pilih model, mulai mendesain. macOS (Apple Silicon & Intel), Windows, dan Linux.',
    breadcrumb: 'Unduh',
    label: 'Unduh',
    heading: 'Unduh design for air.',
    lead:
    ...
    autoCtaFallback: 'Unduh design for air',
    ...
    ctaBody:
      'Pasang dari sumber dengan tiga perintah, atau jalankan design for air secara headless dari agen coding Anda yang sudah ada.',
  },
  nl: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'design for air downloaden — desktop-app voor macOS, Windows en Linux',
    description:
      'Download de nieuwste design for air desktop-build. Installeren en maken — één keer inloggen, een model kiezen en beginnen met ontwerpen. macOS (Apple Silicon en Intel), Windows en Linux.',
    breadcrumb: 'Downloaden',
    label: 'Downloaden',
    heading: 'design for air downloaden.',
    lead:
    ...
    autoCtaFallback: 'design for air downloaden',
    ...
    ctaBody:
      'Installeer vanuit de broncode met drie commando’s, of stuur design for air headless aan vanuit je bestaande coding-agent.',
  },
  ar: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'تنزيل design for air — تطبيق سطح المكتب لنظام macOS وWindows وLinux',
    description:
      'نزّل أحدث إصدار سطح مكتب من design for air. ثبّت وابدأ الإنشاء — سجّل الدخول مرة واحدة، اختر نموذجًا، وابدأ التصميم. يدعم macOS (Apple Silicon وIntel) وWindows وLinux.',
    breadcrumb: 'تنزيل',
    label: 'تنزيل',
    heading: 'تنزيل design for air.',
    lead:
    ...
    autoCtaFallback: 'تنزيل design for air',
    recommended: 'موصى به',
    ...
    ctaBody:
      'ثبّت من المصدر بثلاثة أوامر، أو شغّل design for air بوضع headless من وكيل البرمجة الحالي لديك.',
  },
  tr: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'design for air’i indir — macOS, Windows ve Linux için masaüstü uygulaması',
    description:
      'En son design for air masaüstü sürümünü indirin. Kurun ve üretmeye başlayın — bir kez giriş yapın, bir model seçin, tasarlamaya başlayın. macOS (Apple Silicon ve Intel), Windows ve Linux.',
    breadcrumb: 'İndir',
    label: 'İndir',
    heading: 'design for air’i indir.',
    lead:
    ...
    autoCtaFallback: 'design for air’i indir',
    ...
    ctaBody:
      'Kaynaktan üç komutla kurun veya design for air’i mevcut kodlama aracınızdan headless olarak çalıştırın.',
  },
  uk: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Завантажити design for air — десктопний застосунок для macOS, Windows і Linux',
    description:
      'Завантажте найновішу десктопну збірку design for air. Встановіть і творіть — увійдіть один раз, виберіть модель, почніть проєктувати. macOS (Apple Silicon та Intel), Windows і Linux.',
    breadcrumb: 'Завантажити',
    label: 'Завантажити',
    heading: 'Завантажити design for air.',
    lead:
    ...
    autoCtaFallback: 'Завантажити design for air',
    ...
    ctaBody:
      'Встановіть із джерел трьома командами або керуйте design for air у headless-режимі з наявного агента для кодування.',
  },
};
...
INFO_PAGE_COPY.zh = {
  ...
  official: {
    ...
    title: '官方 design for air —— 来源页、GitHub、发布与别名',
    description:
      'design for air 官方来源页：canonical 网站、GitHub 仓库、发布、Discord、许可证和维护者身份都集中在这里。',
    breadcrumb: '官方',
    label: '来源 · Nº 00',
    heading: '官方 design for air 来源页。',
    lead:
      'design for air（也会被搜索为 OpenDesign、open-design、opendesign 或 design for air AI）是 nexu-io/open-design 项目的官方开源 AI 设计工作台。这个页面列出所有 canonical 入口，方便你自行核验来源。',
    ...
    maintainerBody:
      'design for air 在 github.com/nexu-io/open-design 公开开发，并以 Apache-2.0 发布。Issue、RFC 和路线图讨论都在 GitHub Issues 与 Discord 进行。',
    runtimeTitle: '你的机器上运行什么',
    runtimeBody: 'design for air 提供三个可运行表面，全部开源、全部本地优先：',
    runtimeItems: [
  ...
  quickstart: {
    ...
    title: 'design for air 快速开始 —— 三条命令安装（Node 24、pnpm）',
    description:
      '用三条命令在本地安装 design for air。包含 Node 24、pnpm 10.33.2 要求、命令、预期输出、排障和首次生成设计 artifact 的步骤。',
    breadcrumb: '快速开始',
    label: '安装 · Nº 01',
    heading: 'design for air 快速开始。',
    lead: 'design for air 完全运行在你的机器上。三条命令就能从干净 checkout 到本地 daemon、Web UI 和第一个设计 artifact。',
    ...
    nextItems: [
      ...
      { label: '比较 design for air', body: '了解它和 Claude Design、Figma Make、v0、Lovable 的差异。' },
  ...
  agents: {
    ...
    title: 'design for air Agent —— {count} 个 BYOK 适配器',
    description: 'design for air 内置 {count} 个 BYOK 适配器。直接用你写代码时已经在用的 Agent 来驱动设计，无需额外厂商登录。',
    breadcrumb: 'Agent',
    label: '适配器 · Nº 04',
    heading: (count) => `${count} 个 BYOK Agent，一套 Skill 协议。`,
    lead: (count) =>
      `design for air 内置 ${count} 个一方适配器。同一套可组合 Skill 和可移植 DESIGN.md 系统可以用于每一个 Agent。全程 BYOK：你的密钥、你的成本、你的数据。`,
    adaptersTitle: '适配器如何接入',
    adaptersBody:
      '每个适配器都是很薄的一层 shim，把 Agent 原生消息格式翻译成 design for air Skill 协议。新增适配器通常只是一个文件，不需要 fork 整个产品。',
    tiers: [
      { label: 'Tier 1 —— 一方日常验证', blurb: 'design for air 维护者每天使用的适配器。支持时会使用 Stream-JSON IPC、AskUserQuestion 中途交互和 Skill-aware system prompt。' },
    ...
    byokLead: 'design for air 中的 BYOK（bring your own key）意味着凭据和成本都留在你这一侧：',
    byokItems: [
    ...
    ctaBody: '选择你电脑上已有的 Agent，把 design for air 指向它，然后开始渲染。',
  },
  compare: {
    ...INFO_PAGE_COPY.en!.compare,
    title: 'design for air vs Claude Design、Figma Make、v0、Lovable —— 诚实对比',
    description:
      '比较 design for air 与主流 AI 设计工具：云端托管 vs 本地优先、BYOK vs 厂商锁定、一次性生成 vs 可移植 DESIGN.md 系统。',
    breadcrumb: '对比',
    label: '评估 · Nº 02',
    heading: 'design for air 与其它工具的对比。',
    lead: '这里用简短、诚实的摘要说明 design for air 与你可能正在评估的其它 AI 设计工具之间的关系。',
    toc: ['vs Claude Design', 'vs Figma Make', 'vs v0', 'vs Lovable / Bolt', 'vs Open CoDesign', '真实限制'],
    comparisons: [
      { competitor: 'Claude Design', summary: '绑定单一厂商的云端产品。design for air 本地优先、BYOK、Apache-2.0，Skill 与 DESIGN.md 都留在你的 repo。', cta: '阅读完整对比 ->' },
      { competitor: 'Figma Make', summary: 'Figma Make 侧重在 Figma 内 prompt-to-mockup。design for air 把可移植 artifact 直接交付到你的项目。', cta: '查看仓库中的迁移说明 ->' },
      { competitor: 'v0 by Vercel', summary: 'v0 在云端 runtime 生成 React 组件。design for air 在本地生成 deck、dashboard、landing page 和品牌系统。', cta: '查看仓库中的迁移说明 ->' },
      { competitor: 'Lovable / Bolt', summary: 'Lovable 和 Bolt 侧重云端 prompt-to-app。design for air 是给你已有 Agent 使用的设计 Skill 层。', cta: '查看仓库中的迁移说明 ->' },
      { competitor: 'Open CoDesign', summary: 'Open CoDesign 是同领域开源项目。design for air 可以通过 Skill 协议包装 codesign 类型工作流。', cta: '查看仓库中的迁移说明 ->' },
    ],
    limitsTitle: '真实限制 —— design for air 不是什么',
    limitsBody: 'design for air 不试图成为所有云端 AI 设计工具。下面的问题说明实际取舍，而不是把限制包装掉。',
    limitsFaq: [
      { name: 'design for air 有云端 Web sandbox 吗？', text: '没有。design for air 的设计目标就是本地优先。' },
      { name: '不安装任何东西可以使用 design for air 吗？', text: '目前不行。最小形态是本地 daemon 加一个 coding agent。' },
      { name: 'design for air 是 v0 / Lovable / Bolt 替代品吗？', text: '取决于场景。design for air 聚焦通过可 fork 的 Skill 协议生成设计 artifact。' },
      { name: 'design for air 会把我的数据发给 Anthropic、OpenAI 或 Google 吗？', text: '只会把 prompt 与 Skill 上下文发给你自己带 key 的 provider。' },
      { name: '可以把 design for air 自托管到自己的基础设施吗？', text: '可以。Apache-2.0、Node 24 daemon、没有必需 SaaS。' },
    ],
  },
  claudeAlternative: {
    ...INFO_PAGE_COPY.en!.claudeAlternative,
    title: 'Claude Design 开源替代方案 —— design for air（BYOK、本地优先）',
    description:
      'design for air 是 Claude Design 的开源、本地优先替代方案。支持 Claude Code、Codex、Cursor、Gemini、OpenCode 或 Qwen 的 BYOK 工作流。',
    breadcrumb: 'Claude Design 开源替代方案',
    label: '替代方案 · Nº 03',
    heading: 'Claude Design 的开源替代方案。',
    lead:
      'design for air 是官方开源、本地优先的 Claude Design 替代方案。你可以用自己已有的 Agent BYOK，把品牌保存为可移植 DESIGN.md 文件，并把 artifact 作为项目文件交付。',
    tldrTitle: '简版结论',
    ...
    localByokBody: [
      'design for air 在你的机器上运行桌面应用、本地 daemon，以及 Markdown 形式的 Skill/System 目录。',
    ...
    pickOpenTitle: '适合 design for air 的情况',
    ...
    migrateSteps: ['按快速开始安装 design for air。', '打开 Web UI，让 Agent 查看一个你喜欢的 Claude Design artifact。', '让 Agent 把品牌提取成 DESIGN.md 文件。', '选择一个 Skill，用新品牌渲染。'],
    migrateClosing: '之后每个 Skill 都能沿用你的品牌，不需要反复重新提示。',
    faqTitle: 'FAQ',
    faq: [
      { name: 'design for air 真的是 Claude Design 的 drop-in 替代吗？', text: '不是字面上的 drop-in，但它们都覆盖 prompt-to-design-artifact 这个用途。' },
      { name: '可以在 design for air 中使用 Claude 作为 Agent 吗？', text: '可以。design for air 支持 Claude Code 和 Anthropic API BYOK。' },
      { name: '我的 Claude Design 设计怎么办？', text: '你可以继续并行使用 Claude Design；目前迁移是手动的。' },
      { name: 'design for air 能生成相同类型的 artifact 吗？', text: '常见类型可以：落地页、演示文稿、仪表盘、社交内容、品牌系统和原型。' },
      { name: '为什么说 open-source Claude Design，而不是 open-source AI design tool？', text: '因为很多用户就是用这个形状来描述他们在找的产品。' },
      { name: '谁在构建和维护 design for air？', text: '项目位于 github.com/nexu-io/open-design，许可证为 Apache-2.0。' },
    ],
    ctaTitle: '三条命令切换。',
  ...
  download: {
    ...INFO_PAGE_COPY.en!.download,
    title: '下载 design for air —— macOS / Windows / Linux 桌面客户端',
    description:
      '下载最新版 design for air 桌面客户端。装上就能创作——登录一次、选个模型、开始设计。支持 macOS（Apple Silicon 与 Intel）、Windows、Linux。',
    breadcrumb: '下载',
    label: '下载',
    heading: '下载 design for air。',
    lead: '装上就能创作——不需要 API key、零配置。桌面端内置官方 model router，登录一次即可开始设计。',
    autoCtaPrefix: '下载适用于',
    autoCtaFallback: '下载 design for air',
    recommended: '推荐',
    publishedPrefix: '发布于',
    releaseNotes: '更新日志',
    platformsTitle: '全部平台',
    ...
    ctaTitle: '更喜欢用终端？',
    ctaBody: '三条命令从源码安装，或用你现有的编码 agent 以 headless 方式驱动 design for air。',
  },
};
...
INFO_PAGE_COPY['zh-tw'] = {
  ...
  official: {
    ...
    title: '官方 design for air —— 來源頁、GitHub、發布與別名',
    description:
      'design for air 官方來源頁：canonical 網站、GitHub repo、發布、Discord、授權與維護者身份都集中在這裡。',
    breadcrumb: '官方',
    heading: '官方 design for air 來源頁。',
    lead:
      'design for air（也會被搜尋為 OpenDesign、open-design、opendesign 或 design for air AI）是 nexu-io/open-design 專案的官方開源 AI 設計工作台。這個頁面列出所有 canonical 入口，方便你自行核驗來源。',
    canonicalBody: '請收藏 open-design.ai 與 GitHub repo。其他入口都應回到這兩個來源之一。',
    aliasesTitle: '命名與別名',
    aliasesLead: '不同工具、受眾與語言環境裡，這個專案會以幾種方式被搜尋和書寫：',
    aliases: [
      { label: 'design for air', body: '產品 UI、部落格與 README 中的展示名。' },
      ...
      { label: 'design for air AI', body: '用來區分通用 open design 話題的長尾搜尋詞。' },
      { label: 'OD', body: 'runtime 與 CLI bin 的內部縮寫。' },
    ],
    aliasesClosing: '這六個名稱都指向同一個專案。canonical URL 永遠是 open-design.ai。',
    maintainerBody:
      'design for air 在 github.com/nexu-io/open-design 公開開發，並以 Apache-2.0 發布。Issue、RFC 與路線圖討論都在 GitHub Issues 與 Discord 進行。',
    runtimeTitle: '你的機器上執行什麼',
    runtimeBody: 'design for air 提供三個可執行表面，全部開源、全部本地優先：',
    runtimeItems: [
  ...
  quickstart: {
    ...
    title: 'design for air 快速開始 —— 三條命令安裝（Node 24、pnpm）',
    description:
      '用三條命令在本地安裝 design for air。包含 Node 24、pnpm 10.33.2 要求、命令、預期輸出、排障與首次生成設計 artifact 的步驟。',
    breadcrumb: '快速開始',
    heading: 'design for air 快速開始。',
    lead: 'design for air 完全執行在你的機器上。三條命令就能從乾淨 checkout 到本地 daemon、Web UI 和第一個設計 artifact。',
  ...
  agents: {
    ...
    title: 'design for air Agent —— {count} 個 BYOK adapter',
    description: 'design for air 內建 {count} 個 BYOK adapter。直接用你寫程式時已經在用的 Agent 來驅動設計，無需額外供應商登入。',
    breadcrumb: 'Agent',
    heading: (count) => `${count} 個 BYOK Agent，一套 Skill 協議。`,
    lead: (count) =>
      `design for air 內建 ${count} 個一方 adapter。同一套可組合 Skill 與可移植 DESIGN.md 系統可以用於每一個 Agent。全程 BYOK：你的密鑰、你的成本、你的資料。`,
    adaptersTitle: 'Adapter 如何接入',
    adaptersBody:
      '每個 adapter 都是很薄的一層 shim，把 Agent 原生訊息格式翻譯成 design for air Skill 協議。新增 adapter 通常只是一個檔案，不需要 fork 整個產品。',
    vendor: '供應商',
    credential: '憑據',
    byokTitle: '這裡的 BYOK 是什麼意思',
    byokLead: 'design for air 中的 BYOK（bring your own key）意味著憑據和成本都留在你這一側：',
    byokItems: [
    ...
    ctaBody: '選擇你電腦上已有的 Agent，把 design for air 指向它，然後開始渲染。',
  },
  compare: {
    ...INFO_PAGE_COPY.zh!.compare,
    title: 'design for air vs Claude Design、Figma Make、v0、Lovable —— 誠實比較',
    breadcrumb: '比較',
    label: '評估 · Nº 02',
    heading: 'design for air 與其他工具的比較。',
    lead: '這裡用簡短、誠實的摘要說明 design for air 與你可能正在評估的其他 AI 設計工具之間的關係。',
    limitsTitle: '真實限制 —— design for air 不是什麼',
    limitsBody: 'design for air 不試圖成為所有雲端 AI 設計工具。下面的問題說明實際取捨，而不是把限制包裝掉。',
  },
  claudeAlternative: {
    ...INFO_PAGE_COPY.zh!.claudeAlternative,
    title: 'Claude Design 開源替代方案 —— design for air（BYOK、本地優先）',
    description:
      'design for air 是 Claude Design 的開源、本地優先替代方案。支援 Claude Code、Codex、Cursor、Gemini、OpenCode 或 Qwen 的 BYOK 工作流。',
    breadcrumb: 'Claude Design 開源替代方案',
    label: '替代方案 · Nº 03',
    heading: 'Claude Design 的開源替代方案。',
    lead:
      'design for air 是官方開源、本地優先的 Claude Design 替代方案。你可以用自己已有的 Agent BYOK，把品牌保存為可移植 DESIGN.md 檔案，並把 artifact 作為專案檔案交付。',
    tldrTitle: '簡版結論',
    ...
    pickOpenTitle: '適合 design for air 的情況',
    migrateTitle: '遷移 / 首次執行',
    faqTitle: 'FAQ',
    faq: [
      { name: 'design for air 真的是 Claude Design 的 drop-in 替代嗎？', text: '不是字面上的 drop-in，但它們都覆蓋 prompt-to-design-artifact 這個用途。' },
      { name: '可以在 design for air 中使用 Claude 作為 Agent 嗎？', text: '可以。design for air 支援 Claude Code 和 Anthropic API BYOK。' },
      { name: '我的 Claude Design 設計怎麼辦？', text: '你可以繼續並行使用 Claude Design；目前遷移是手動的。' },
      { name: 'design for air 能生成相同類型的 artifact 嗎？', text: '常見類型可以：落地頁、簡報、儀表板、社群內容、品牌系統和原型。' },
      { name: '為什麼說 open-source Claude Design，而不是 open-source AI design tool？', text: '因為很多使用者就是用這個形狀來描述他們在找的產品。' },
      { name: '誰在構建和維護 design for air？', text: '專案位於 github.com/nexu-io/open-design，授權為 Apache-2.0。' },
    ],
    ctaTitle: '三條命令切換。',
...
> = {
  ja: {
    ...
    reusable: {
      sourceBody: 'この項目は design for air の正規の入口と同じプロジェクトを指します。',
    ...
    official: {
      title: '公式 design for air — 出典、GitHub、リリース、別名',
      description: 'design for air の正規ページ、GitHub、リリース、コミュニティ、ライセンスをまとめた確認用ページです。',
      breadcrumb: '公式',
      label: '出典 · Nº 00',
      heading: '公式 design for air 出典ページ。',
      lead: 'design for air は nexu-io/open-design プロジェクトのオープンソース AI デザインワークスペースです。',
    },
    quickstart: {
      title: 'design for air クイックスタート — Node 24 と pnpm で開始',
      description: 'design for air をローカルに入れ、daemon、Web UI、最初の artifact まで進む手順です。',
      breadcrumb: 'クイックスタート',
      label: 'インストール · Nº 01',
      heading: 'design for air クイックスタート。',
      lead: 'ローカル環境だけで起動し、既存のエージェントからデザイン生成を始められます。',
      ctaTitle: 'ローカルで始める。',
    },
    agents: {
      title: 'design for air エージェント — {count} 個の BYOK アダプター',
      description: '普段使っているコーディングエージェントから design for air のスキルを実行できます。',
      breadcrumb: 'エージェント',
      label: 'アダプター · Nº 04',
      heading: '{count} 個の BYOK エージェント、1 つのスキルプロトコル。',
      lead: 'design for air は {count} 個のアダプターで、同じスキルと DESIGN.md を複数のエージェントから使えます。',
      ctaTitle: '{count} 個のアダプター。あなたのエージェント。',
    },
    compare: {
      title: 'design for air と主要 AI デザインツールの比較',
      description: 'ローカル優先、BYOK、オープンソース、ポータブルな DESIGN.md という観点で比較します。',
      breadcrumb: '比較',
      label: '評価 · Nº 02',
      heading: 'design for air と他の選択肢。',
      lead: 'design for air はホスト型ツールではなく、エージェントで動かすローカル優先のデザイン層です。',
    },
    claudeAlternative: {
      title: 'Claude Design のオープンソース代替 — design for air',
      description: 'design for air は BYOK とローカル優先を軸にした Claude Design 代替です。',
...
function compactInfoTextFromHome(locale: LandingLocaleCode): CompactInfoPageText {
  ...
  return {
    ...
    official: {
      title: `${labels.official} · design for air`,
      description: summary,
      breadcrumb: labels.official,
      label: labels.official,
      heading: `${labels.official} · design for air`,
      lead,
    },
    quickstart: {
      title: `${labels.quickstart} · design for air`,
      description: lead,
      breadcrumb: labels.quickstart,
      label: labels.quickstart,
      heading: `${labels.quickstart} · design for air`,
      lead,
      ctaTitle: labels.next,
    },
    agents: {
      title: `${labels.agents} · design for air`,
      description: lead,
    ...
    compare: {
      title: `${labels.compare} · design for air`,
      description: summary,
      breadcrumb: labels.compare,
      label: labels.compare,
      heading: `${labels.compare} · design for air`,
      lead,
    },
    claudeAlternative: {
      title: `${labels.alternative} · design for air`,
      description: summary,
      breadcrumb: labels.alternative,
      label: labels.alternative,
      heading: `${labels.alternative} · design for air`,
