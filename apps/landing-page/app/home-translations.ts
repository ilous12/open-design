...
export interface HomeExtra {
  ...
  stepDesc4: string;
  capTitle: string;
  labsPre: string; // before <em>design for air</em>
  labsPost: string; // after <em>design for air</em> (incl. punctuation)
  methodTitle: string;
  ctaTitle: string;
...
const en: HomeExtra = {
  ...
  heroSub:
    'design for air is the open-source, local, agent-native design platform — and an agent-native Figma alternative. Desktop-first, with 21 coding agents, 129 design systems, and an Apache-2.0 license.',
  aboutKicker: 'Why design for air?',
  aboutStatement:
    'In April 2026, Claude Design first proved an LLM can truly design — not write copy, but produce real design work. But it’s closed-source, paid, and cloud-only, locked to Anthropic models — no agent switching, no self-hosting, no BYOK. design for air opens that capability up.',
  ...
  testiPost: 'are building design for air together',
  newsTitle: 'The design for air newsletter',
  newsDesc:
...
const zh: HomeExtra = {
  ...
  aboutKicker: '为什么选择 design for air？',
  aboutStatement:
    '2026 年 4 月，Claude Design 首次证明 LLM 能真正做设计，不是写文章，是直接产出设计稿。但它闭源、付费、只跑在云端，模型锁 Anthropic，换 Agent、自部署、BYOK 全做不到。design for air 让这套能力变得开放。',
  aboutTab1: '桌面端原生',
  aboutTab2: '不造 Agent，接入 Agent',
  aboutTab3: '越用越懂你',
  aboutCap1: '设计在桌面端发生。\n本地文件、Figma 导出、代码仓库直接可读，Agent 拥有终端执行全部能力',
  aboutCap2: '你电脑上的 Claude Code / Codex / Cursor 已经够强。\ndesign for air 做的是把它们接进完整设计工作流',
  ...
  testiPre: '来自全球，',
  testiMid: ' 贡献者',
  testiPost: '正在一起构建 design for air',
  newsTitle: 'design for air 订阅',
...
const zhTw: HomeExtra = {
  ...
  aboutKicker: '為什麼選擇 design for air？',
  aboutStatement:
    '2026 年 4 月，Claude Design 首次證明 LLM 能真正做設計，不是寫文章，而是直接產出設計稿。但它閉源、付費、只跑在雲端，模型鎖 Anthropic，換 Agent、自部署、BYOK 全做不到。design for air 讓這套能力變得開放。',
  aboutTab1: '桌面端原生',
  aboutTab2: '不造 Agent，接入 Agent',
  aboutTab3: '越用越懂你',
  aboutCap1: '設計在桌面端發生。\n本地檔案、Figma 匯出、程式碼倉庫直接可讀，Agent 擁有終端執行全部能力',
  aboutCap2: '你電腦上的 Claude Code / Codex / Cursor 已經夠強。\ndesign for air 做的是把它們接進完整設計工作流',
  ...
  testiPre: '來自全球，',
  testiMid: ' 貢獻者',
  testiPost: '正在一起打造 design for air',
  newsTitle: 'design for air 訂閱',
...
const ja: HomeExtra = {
  ...
  aboutKicker: 'なぜ design for air なのか？',
  aboutStatement:
    '2026 年 4 月、Claude Design は LLM が本当にデザインできることを初めて証明しました。文章ではなく、実際のデザイン成果物を生み出すのです。しかしクローズドソースで有料、クラウド専用、Anthropic モデルに固定——エージェントの切り替え、セルフホスト、BYOK はすべて不可。design for air はその能力をオープンにします。',
  ...
  testiPost: 'が一緒に design for air を作っています',
  newsTitle: 'design for air ニュースレター',
  newsDesc:
...
const ko: HomeExtra = {
  ...
  aboutKicker: '왜 design for air인가?',
  aboutStatement:
    '2026년 4월, Claude Design은 LLM이 글이 아니라 실제 디자인 결과물을 만들 수 있음을 처음으로 증명했습니다. 하지만 폐쇄형에 유료, 클라우드 전용이며 Anthropic 모델에 묶여 있어 에이전트 교체, 셀프 호스팅, BYOK가 모두 불가능합니다. design for air은 그 능력을 개방합니다.',
  aboutTab1: '데스크톱 네이티브',
  ...
  testiPre: '전 세계에서, ',
  testiMid: '명의 기여자',
  testiPost: '가 함께 design for air을 만들고 있습니다',
  newsTitle: 'design for air 뉴스레터',
  newsDesc:
...
const de: HomeExtra = {
  ...
  aboutKicker: 'Warum design for air?',
  aboutStatement:
    'Im April 2026 bewies Claude Design erstmals, dass ein LLM wirklich gestalten kann — keine Texte, sondern echte Design-Arbeit. Aber es ist Closed Source, kostenpflichtig und nur in der Cloud, an Anthropic-Modelle gebunden — kein Agent-Wechsel, kein Self-Hosting, kein BYOK. design for air öffnet diese Fähigkeit.',
  ...
  testiPost: 'gemeinsam an design for air',
...
const fr: HomeExtra = {
  ...
  aboutKicker: 'Pourquoi design for air ?',
  aboutStatement:
    'En avril 2026, Claude Design a prouvé pour la première fois qu’un LLM pouvait vraiment concevoir — non pas écrire, mais produire un véritable travail de design. Mais il est propriétaire, payant et uniquement cloud, verrouillé aux modèles Anthropic — pas de changement d’agent, pas d’auto-hébergement, pas de BYOK. design for air ouvre cette capacité.',
  ...
  testiPost: 'construisent design for air ensemble',
  newsTitle: 'La newsletter design for air',
  newsDesc:
...
const ru: HomeExtra = {
  ...
  aboutKicker: 'Почему design for air?',
  aboutStatement:
    'В апреле 2026 года Claude Design впервые доказал, что LLM может действительно проектировать — не писать тексты, а создавать настоящую дизайн-работу. Но он закрытый, платный и только в облаке, привязан к моделям Anthropic — никакой смены агента, самостоятельного хостинга или BYOK. design for air делает эту возможность открытой.',
  ...
  testiMid: ' участников',
  testiPost: 'вместе создают design for air',
  newsTitle: 'Рассылка design for air',
  newsDesc:
...
const es: HomeExtra = {
  ...
  aboutKicker: '¿Por qué design for air?',
  aboutStatement:
    'En abril de 2026, Claude Design demostró por primera vez que un LLM puede diseñar de verdad — no escribir textos, sino producir trabajo de diseño real. Pero es de código cerrado, de pago y solo en la nube, atado a los modelos de Anthropic — sin cambio de agente, sin self-hosting, sin BYOK. design for air abre esa capacidad.',
  ...
  testiPost: 'construyen design for air juntos',
  newsTitle: 'La newsletter de design for air',
  newsDesc:
...
const ptBr: HomeExtra = {
  ...
  testiMid: ' colaboradores',
  testiPost: 'constroem o design for air juntos',
  newsTitle: 'A newsletter do design for air',
  newsDesc:
...
const it: HomeExtra = {
  ...
  aboutKicker: 'Perché design for air?',
  aboutStatement:
    'Ad aprile 2026, Claude Design ha dimostrato per la prima volta che un LLM può davvero progettare — non scrivere testi, ma produrre vero lavoro di design. Ma è closed-source, a pagamento e solo cloud, legato ai modelli Anthropic — niente cambio di agente, niente self-hosting, niente BYOK. design for air apre questa capacità.',
  ...
  testiPost: 'costruiscono design for air insieme',
  newsTitle: 'La newsletter di design for air',
  newsDesc:
...
const vi: HomeExtra = {
  ...
  aboutKicker: 'Vì sao chọn design for air?',
  aboutStatement:
    'Tháng 4 năm 2026, Claude Design lần đầu chứng minh rằng LLM có thể thực sự thiết kế — không phải viết chữ, mà tạo ra sản phẩm thiết kế thật. Nhưng nó đóng mã nguồn, trả phí và chỉ chạy trên đám mây, khóa vào mô hình Anthropic — không đổi agent, không self-host, không BYOK. design for air mở khả năng đó ra.',
  ...
  aboutCap2:
    'Claude Code / Codex / Cursor trên máy bạn đã đủ mạnh.\ndesign for air kết nối chúng vào một quy trình thiết kế hoàn chỉnh.',
  ...
  testiPost: 'đang cùng xây dựng design for air',
  newsTitle: 'Bản tin design for air',
  newsDesc:
...
const pl: HomeExtra = {
  ...
  testiPost: 'wspólnie buduje design for air',
  newsTitle: 'Newsletter design for air',
  newsDesc:
...
const id: HomeExtra = {
  ...
  aboutKicker: 'Mengapa design for air?',
  aboutStatement:
    'Pada April 2026, Claude Design pertama kali membuktikan bahwa LLM benar-benar bisa mendesain — bukan menulis teks, melainkan menghasilkan karya desain nyata. Tapi ia tertutup, berbayar, dan hanya cloud, terkunci pada model Anthropic — tanpa ganti agen, tanpa self-hosting, tanpa BYOK. design for air membuka kemampuan itu.',
  ...
  aboutCap2:
    'Claude Code / Codex / Cursor di mesin Anda sudah cukup kuat.\ndesign for air menyambungkannya ke alur desain yang lengkap.',
  ...
  testiPost: 'membangun design for air bersama',
  newsTitle: 'Newsletter design for air',
  newsDesc:
...
const nl: HomeExtra = {
  ...
  aboutKicker: 'Waarom design for air?',
  aboutStatement:
    'In april 2026 bewees Claude Design voor het eerst dat een LLM echt kan ontwerpen — geen teksten schrijven, maar echt designwerk maken. Maar het is closed-source, betaald en alleen cloud, vastgezet op Anthropic-modellen — geen agent wisselen, geen self-hosting, geen BYOK. design for air opent die mogelijkheid.',
  aboutTab1: 'Desktop-native',
  ...
  testiMid: ' bijdragers',
  testiPost: 'samen aan design for air',
  newsTitle: 'De design for air-nieuwsbrief',
  newsDesc:
...
const ar: HomeExtra = {
  ...
  aboutKicker: 'لماذا design for air؟',
  aboutStatement:
    'في أبريل 2026، أثبت Claude Design لأول مرة أن نموذج اللغة يمكنه التصميم فعلاً — لا كتابة النصوص، بل إنتاج عمل تصميمي حقيقي. لكنه مغلق المصدر ومدفوع وسحابي فقط، مقيّد بنماذج Anthropic — لا تبديل للوكيل، ولا استضافة ذاتية، ولا BYOK. يفتح design for air هذه القدرة.',
  ...
  aboutCap2:
    'إن Claude Code / Codex / Cursor على جهازك قوية بما يكفي.\nيقوم design for air بوصلها ضمن سير عمل تصميمي متكامل.',
  ...
  testiMid: ' مساهماً',
  testiPost: 'يبنون design for air معاً',
  newsTitle: 'نشرة design for air البريدية',
  newsDesc:
...
const tr: HomeExtra = {
  ...
  aboutKicker: 'Neden design for air?',
  aboutStatement:
    'Nisan 2026’da Claude Design, bir LLM’in gerçekten tasarım yapabildiğini ilk kez kanıtladı — metin yazmak değil, gerçek tasarım işi üretmek. Ama kapalı kaynak, ücretli ve yalnızca bulutta, Anthropic modellerine kilitli — ajan değiştirme yok, self-hosting yok, BYOK yok. design for air bu yeteneği açar.',
  ...
  testiMid: ' katkıcı',
  testiPost: 'birlikte design for air’ı inşa ediyor',
  newsTitle: 'design for air bülteni',
  newsDesc:
...
const uk: HomeExtra = {
  ...
  aboutKicker: 'Чому design for air?',
  aboutStatement:
    'У квітні 2026 року Claude Design уперше довів, що LLM може справді проєктувати — не писати тексти, а створювати реальну дизайн-роботу. Але він закритий, платний і лише в хмарі, прив’язаний до моделей Anthropic — без зміни агента, без self-hosting, без BYOK. design for air відкриває цю можливість.',
  ...
  testiMid: ' учасників',
  testiPost: 'разом будують design for air',
  newsTitle: 'Розсилка design for air',
  newsDesc:
