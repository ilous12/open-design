...
export const ENTERPRISE_EMAIL = 'support@nn-design.ai';
...
const ENTERPRISE_ZH: EnterpriseCopy = {
  ...
  leadForm: {
    ...
    errorSubmit: "提交失败，请稍后重试，或邮件联系 support@nn-design.ai",
    close: "关闭",
  },
};
...
const ENTERPRISE_EN: EnterpriseCopy = {
  ...
  leadForm: {
    ...
    errorSubmit: "Couldn't submit — please try again or email support@nn-design.ai",
    close: "Close",
  },
};
...
const ENTERPRISE_ZH_TW: EnterpriseCopy = {
  ...
  leadForm: {
    ...
    errorSubmit: "提交失敗，請稍後重試，或來信 support@nn-design.ai",
    close: "關閉",
  },
};
...
const ENTERPRISE_PT_BR: EnterpriseCopy = {
  ...
  leadForm: {
    ...
    errorSubmit: "Não foi possível enviar. Tente novamente ou escreva para support@nn-design.ai",
    close: "Fechar",
  },
};
...
const ENTERPRISE_ES: EnterpriseCopy = {
  ...
  leadForm: {
    ...
    errorSubmit: "No se pudo enviar. Inténtalo de nuevo o escribe a support@nn-design.ai",
    close: "Cerrar",
  },
};
...
const ENTERPRISE_RU: EnterpriseCopy = {
  ...
  leadForm: {
    ...
    errorSubmit: "Не удалось отправить. Повторите попытку или напишите на support@nn-design.ai",
    close: "Закрыть",
  },
};
...
const ENTERPRISE_FR: EnterpriseCopy = {
  ...
  leadForm: {
    ...
    errorSubmit: "Échec de l'envoi — réessayez ou écrivez à support@nn-design.ai",
    close: "Fermer",
  },
};
...
const ENTERPRISE_KO: EnterpriseCopy = {
  ...
  leadForm: {
    ...
    errorSubmit: "제출에 실패했습니다. 다시 시도하거나 support@nn-design.ai로 문의해 주세요.",
    close: "닫기",
  },
};
...
const ENTERPRISE_DE: EnterpriseCopy = {
  ...
  leadForm: {
    ...
    errorSubmit: "Senden fehlgeschlagen — bitte erneut versuchen oder an support@nn-design.ai schreiben",
    close: "Schließen",
  },
};
...
const ENTERPRISE_JA: EnterpriseCopy = {
  ...
  leadForm: {
    ...
    errorSubmit: "送信に失敗しました。もう一度お試しいただくか、support@nn-design.ai までご連絡ください。",
    close: "閉じる",
  },
};
