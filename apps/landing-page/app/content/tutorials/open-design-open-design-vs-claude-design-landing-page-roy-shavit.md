...
summary: A cost-first guide to design for air — escape the token cap by running design through the agent you already pay for (or your own key), build a full landing page, even generate a video, and deploy. Plus an honest "when to use which tool" call. Based on Roy Shavit's walkthrough.
date: 2026-06-14
category: Demo
durationSeconds: 866
...
Open the local URL it prints (a dynamic port — don't hardcode one). In settings, design for air **immediately recognizes the models installed locally** — Roy has Codex and Claude, and it would pick up OpenCode or others too. Set a default, or bring your own key from any provider so you don't even need a CLI installed. This is the uniqueness: you're not forced onto one vendor.

![Slide-deck mode in design for air with example decks.](/tutorials/open-design-open-design-vs-claude-design-landing-page-roy-shavit/slide-deck-creator.webp)
...
![A real prototype generated in design for air.](/tutorials/open-design-open-design-vs-claude-design-landing-page-roy-shavit/generated-prototype.webp)
