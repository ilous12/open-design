...
import type { DesignSystemEditClickProps, TrackingProjectKind } from '@nn-design/contracts/analytics';
...
import type { ChatSessionMode, WorkspaceContextItem } from '@nn-design/contracts';
