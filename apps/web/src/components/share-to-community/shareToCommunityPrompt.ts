// Trigger prompt for the post-completion "Share to Design For AIR" submission
...
export const SHARE_TO_COMMUNITY_PROMPT = [
  'Package the work I just finished in this project as an Design For AIR plugin so I can install it into My plugins and open a PR to the Design For AIR community catalog.',
  '',
