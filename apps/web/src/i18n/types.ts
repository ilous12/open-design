...
export interface Dict {
  ...
  'dsCreate.heroEyebrow': string;
  'dsCreate.heroTitle': string;
  'dsCreate.heroBody': string;
  'dsCreate.heroMetaSteps': string;
  'dsCreate.heroMetaMinutes': string;
  'dsCreate.heroMetaDeliverables': string;
  'dsCreate.heroStep1Title': string;
  'dsCreate.heroStep1Desc': string;
  'dsCreate.heroStep2Title': string;
  'dsCreate.heroStep2Desc': string;
  'dsCreate.heroStep3Title': string;
  'dsCreate.heroStep3Desc': string;
  'dsCreate.heroShowcaseTitle': string;
  'dsCreate.heroPalette': string;
  'dsCreate.heroComponents': string;
  'dsCreate.heroGhost': string;
  'dsCreate.sourceProcessing': string;
  'dsCreate.assetEmptyFile': string;
  'dsCreate.assetNoPreview': string;
  'dsCreate.assetDropAria': string;
  'dsCreate.assetDropTitlePrefix': string;
  'dsCreate.assetDropBrowse': string;
  'dsCreate.assetDropHint': string;
  'dsCreate.assetLibraryHint': string;
  'dsCreate.assetStagedAria': string;
  'dsCreate.assetClosePreview': string;
