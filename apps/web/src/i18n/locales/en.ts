...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to design for air — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.amrCard.switchCta': 'Switch to design for air & retry',
  'chat.amrError.authMessage': 'Your design for air account isn\'t authorized yet. Authorize it and this run retries automatically.',
  'chat.amrError.balanceMessage': 'Your design for air balance has run out. Top up to keep this run going.',
  ...
  'chat.runError.signInMessage.amr': 'The design for air agent isn\'t signed in yet — sign in to start using it.',
  'chat.runError.signInMessage.other': '{agent} isn\'t signed in. Check its sign-in status locally. We recommend the design for air agent — steadier and better value.',
  ...
  'chat.contextPrompt.referenceProject': 'Use the design for air project “{name}” as reference context. Its local path is: {path}. Before designing or modifying anything, search and read this directory when useful.',
  ...
  'settings.welcomeTitle': 'Welcome to design for air',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. design for air will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. design for air reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingAmrModelSourceLabel': 'design for air',
  ...
  'settings.onboardingCloudTitle': 'Use design for air',
  'settings.onboardingCloudBody': 'Choose one of the two ways below to start designing right away.',
  'settings.onboardingCloudSignIn': 'Sign in to design for air',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to design for air to continue.',
  ...
  'settings.onboardingLocalTitle': 'Use Local Coding Agent',
  'settings.onboardingLocalBody': 'Use an installed CLI such as Claude Code CLI, Codex CLI, or Antigravity CLI.',
  'settings.onboardingLocalAction': 'Open CLI settings',
  'settings.onboardingCliScanHint': 'This usually takes 5-10 seconds.',
  'settings.onboardingByokTitle': 'Use API Key',
  'settings.onboardingByokBody': 'Use your own model provider credentials.',
  'settings.onboardingByokAction': 'Open API settings',
  ...
  'settings.subtitle': 'Choose Local CLI or API.',
  ...
  'settings.byokNoFileToolsNotice': 'API mode can\'t read, write, or edit project files. Use Local CLI when you need code changes.',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the design for air daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  ...
  'settings.amrAccountStatus': 'design for air account status',
  ...
  'settings.reasoningPicker': 'Reasoning',
  ...
  'settings.modelCustomPlaceholder': 'e.g. anthropic/claude-sonnet-5',
  ...
  'settings.mcpServerHint': 'Expose design for air as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the design for air team',
  'settings.privacyConsentKicker': 'Help us improve design for air',
  'settings.privacyConsentLead': 'design for air can share usage data with our team to help us improve. This includes:',
  ...
  'settings.updateQuitFailed': 'The installer opened, but design for air could not quit automatically.',
  ...
  'settings.mcpHint': 'Let coding agents (Cursor, Claude Code, VS Code…) read your design for air projects directly.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure design for air is running, then reopen this panel.',
  'settings.mcpBuildDaemon': 'Build the daemon first.',
  'settings.mcpNodeMissing': 'Node binary is missing.',
  'settings.mcpBuildHint': 'apps/daemon/dist/cli.js is missing. Run `pnpm --filter @nn-design/daemon build` and refresh.',
  ...
  'settings.mcpCapabilityDefault': 'Default to the project and file you have open in design for air, so you can say "build this in my app" without re-stating which design.',
  'settings.mcpRunningNote': 'design for air must be running for MCP tool calls to succeed. If you started your coding agent before opening design for air, restart the agent so it can reach the live daemon.',
  ...
  'entry.discordAria': 'Join the design for air Discord',
  'entry.discordAriaWithOnline': 'Join the design for air Discord - {online}',
  ...
  'entry.followLinkedinLabel': 'Follow design for air on LinkedIn',
  'entry.followXiaohongshuLabel': 'Follow design for air on Xiaohongshu',
  ...
  'homeHero.startBlankProject': '…or start a blank prototype',
  'homeHero.templatePicker.label': 'Template',
  'homeHero.templatePicker.searchPlaceholder': 'Search templates',
  'homeHero.templatePicker.projectTypes': 'Prototype',
  ...
  'homeHero.carousel.onePageBrief': 'Draft a one-page web prototype brief',
  'homeHero.carousel.notesToDeck': 'Turn my notes into a web prototype outline',
  'homeHero.carousel.signupFlow': 'Mock up a signup flow',
  'homeHero.carousel.improveBrief': 'Improve an existing web prototype brief',
  'homeHero.carousel.loadingAnimation': 'Create a mobile loading state',
  'homeHero.carousel.teamUpdateSlides': 'Design a web prototype for a team update',
  'homeHero.carousel.ordersDashboard': 'Prototype a web order-tracking flow',
  ...
  'homeHero.carousel.pitchDeck': 'Make a web prototype for a new product',
  'homeHero.carousel.appIdea': 'Describe a mobile prototype idea',
  ...
  'homeHero.chip.liveArtifact': 'Web Prototype',
  'homeHero.chip.deck': 'Web Prototype',
  'homeHero.chip.image': 'Web Prototype',
  'homeHero.chip.video': 'Mobile Prototype',
  'homeHero.chip.hyperframes': 'Mobile Prototype',
  'homeHero.chip.audio': 'Mobile Prototype',
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable design for air plugin and add it to My plugins.',
  ...
  'homeHero.chip.wireframe': 'Web Prototype',
  'homeHero.chip.mobile': 'Mobile Prototype',
  'homeHero.chip.document': 'Web Prototype',
  'homeHero.chip.prototypeDesc': 'Interactive web mockups',
  'homeHero.chip.wireframeDesc': 'Web screens & flows',
  'homeHero.chip.mobileDesc': 'Mobile app screens',
  'homeHero.chip.deckDesc': 'Web prototype narratives',
  'homeHero.chip.documentDesc': 'Web prototype specs',
  'homeHero.chip.imageDesc': 'Web prototype visuals',
  'homeHero.chip.videoDesc': 'Mobile prototype flows',
  'homeHero.chip.audioDesc': 'Mobile prototype interaction notes',
  'homeHero.chip.hyperframesDesc': 'Mobile prototype motion',
  'homeHero.chip.liveArtifactDesc': 'Web prototype states',
  ...
  'homeHero.chip.wireframeNext': 'Open a chat that builds web prototype screens and flows.',
  'homeHero.chip.mobileNext': 'Open a chat that builds a mobile prototype for iOS and Android screens.',
  'homeHero.chip.deckNext': 'Open a chat that builds a structured web prototype.',
  'homeHero.chip.documentNext': 'Open a chat that turns a brief into a web prototype.',
  'homeHero.chip.imageNext': 'Open a chat that creates visuals inside a web prototype.',
  'homeHero.chip.videoNext': 'Open a chat that designs a mobile prototype flow.',
  'homeHero.chip.audioNext': 'Open a chat that adds interaction guidance to a mobile prototype.',
  ...
  'handoff.amrWebsite': 'Visit design for air',
  ...
  'handoff.promptIntro': 'Continue from this local design for air project folder:',
  ...
  'designSystemPicker.noPreview': 'No preview page. design for air Systems to view the full preview.',
  ...
  'pluginsHome.title': 'Reference',
  'pluginsHome.subtitle': 'Ready-to-use design for air workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with design for air and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginsHome.facet.slides': 'Web Prototype',
  'pluginsHome.facet.publicLink': 'Public link',
  'pluginsHome.facet.githubPr': 'GitHub PR',
  'pluginsHome.facet.githubGist': 'GitHub Gist',
  'pluginsHome.subfacet.business-dashboards': 'Web Prototype',
  'pluginsHome.subfacet.app-prototypes': 'Mobile Prototype',
  'pluginsHome.subfacet.landing-marketing': 'Web Prototype',
  'pluginsHome.subfacet.developer-tools': 'Web Prototype',
  'pluginsHome.subfacet.docs-reports': 'Web Prototype',
  'pluginsHome.subfacet.brand-design': 'Web Prototype',
  'pluginsHome.subfacet.pitch-business': 'Web Prototype',
  'pluginsHome.subfacet.course-training': 'Web Prototype',
  'pluginsHome.subfacet.reports-briefings': 'Web Prototype',
  'pluginsHome.subfacet.product-sales': 'Web Prototype',
  'pluginsHome.subfacet.engineering-talks': 'Web Prototype',
  'pluginsHome.subfacet.creative-decks': 'Web Prototype',
  'pluginsHome.subfacet.ui-product-mockups': 'Web Prototype',
  'pluginsHome.subfacet.brand-visuals': 'Web Prototype',
  'pluginsHome.subfacet.storyboards-motion-refs': 'Web Prototype',
  'pluginsHome.subfacet.social-content': 'Web Prototype',
  'pluginsHome.subfacet.avatar-portrait': 'Mobile Prototype',
  'pluginsHome.subfacet.illustration-style': 'Web Prototype',
  'pluginsHome.subfacet.motion-effects': 'Mobile Prototype',
  'pluginsHome.subfacet.social-short-form': 'Mobile Prototype',
  'pluginsHome.subfacet.marketing-product': 'Web Prototype',
  'pluginsHome.subfacet.data-explainers': 'Web Prototype',
  'pluginsHome.subfacet.cinematic-story': 'Mobile Prototype',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to design for air',
  'pluginCard.contributeTitle': 'Contribute plugin to design for air with a pull request',
  ...
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use design for air from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure design for air is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use design for air everywhere',
  'useEverywhere.modalTitle': 'Use design for air everywhere',
  'useEverywhere.modalSubtitle': 'Drop design for air into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'design for air works wherever your agent works',
  'useEverywhere.section.overview.intro': 'design for air is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires design for air as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without design for air at all.',
  ...
  'useEverywhere.section.cli.heading': 'Drive design for air from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose design for air as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'design for air ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover design for air tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the design for air app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  'useEverywhere.section.http.tab': 'HTTP API',
  'useEverywhere.section.http.heading': 'Same REST + SSE surface the web UI uses',
  'useEverywhere.section.http.intro': 'The local daemon serves an HTTP API at `http://127.0.0.1:7456` (port configurable). Every endpoint the web UI calls is also fair game for your scripts. Streaming endpoints (chat turns, project runs) emit Server-Sent Events with the contract types in `@nn-design/contracts`.',
  ...
  'useEverywhere.section.http.footer': 'Pure TypeScript types for every request/response live in `@nn-design/contracts` — import them in your script for full autocomplete without wiring a generator.',
  'useEverywhere.section.skills.tab': 'Skills & headless',
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without design for air running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). design for air extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside design for air and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + design for air extras)',
  ...
  'useEverywhere.section.skills.footer': 'Spec: `docs/skills-protocol.md` and `docs/agent-adapters.md` cover the full adapter surface (Claude Code, Codex, Cursor, MCP-capable agents, API fallback) and the per-adapter skill injection strategies.',
  ...
  'entry.githubStarAria': 'Star design for air on GitHub',
  ...
  'newproj.tabLiveArtifact': 'Web prototype',
  'newproj.tabDeck': 'Web prototype',
  'newproj.tabTemplate': 'From template',
  'newproj.tabMedia': 'Mobile prototype',
  'newproj.tabOther': 'Web prototype',
  'newproj.titlePrototype': 'New prototype',
  'newproj.titleLiveArtifact': 'New web prototype',
  'newproj.titleDeck': 'New web prototype',
  'newproj.titleTemplate': 'Start from a template',
  'newproj.titleImage': 'New web prototype',
  'newproj.titleVideo': 'New mobile prototype',
  'newproj.titleAudio': 'New mobile prototype',
  'newproj.titleMedia': 'New mobile prototype',
  'newproj.titleOther': 'New web prototype',
  ...
  'newproj.locationDefault': 'design for air projects',
  ...
  'newproj.surfaceImage': 'Web prototype',
  'newproj.surfaceVideo': 'Mobile prototype',
  'newproj.surfaceAudio': 'Mobile prototype',
  ...
  'designs.tagLiveArtifact': 'Web Prototype',
  'designs.tagSlide': 'Web Prototype',
  'designs.tagMedia': 'Mobile Prototype',
  ...
  'examples.surfaceImage': 'Web prototype',
  'examples.surfaceVideo': 'Mobile prototype',
  'examples.surfaceAudio': 'Mobile prototype',
  ...
  'examples.modeDeck': 'Web prototypes',
  ...
  'examples.tagSlideDeck': 'Web prototype',
  ...
  'examples.tagImage': 'Web prototype',
  'examples.tagVideo': 'Mobile prototype',
  'examples.tagAudio': 'Mobile prototype',
  ...
  'avatar.useApi': 'Use API',
  'avatar.codeAgent': 'Code agent',
  'avatar.rescan': 'Rescan PATH',
  'avatar.amrConsole': 'design for air',
  ...
  'socialShare.openDesignSection': 'Share design for air',
  'socialShare.openDesignTitle': 'design for air on GitHub',
  'socialShare.openDesignText': 'design for air is an open-source workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  'socialShare.projectText': 'Built with design for air: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with design for air: {title}\n{url}\ndesign for air repo: {repo}',
  ...
  'inlineSwitcher.useByok': 'Use API key',
  ...
  'project.typeDeck': 'Web Prototype',
  'project.typeTemplate': 'Template',
  'project.typeImage': 'Web Prototype',
  'project.typeVideo': 'Mobile Prototype',
  'project.typeAudio': 'Mobile Prototype',
  ...
  'brandEnrichment.body': "design for air will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'chat.activeFilePlaceholder': 'Ask design for air to change {file}...',
  'chat.designArtifactsShowMore': 'Show {count} more design files',
  'chat.mode.chat.label': 'Ask',
  'chat.mode.chat.title': 'Ask mode',
  'chat.mode.chat.summary': 'Clarify the goal, audience, screens, message, and CTA before making a web prototype.',
  'chat.mode.chat.solves': 'Use it to shape a service idea, compare landing-page structures, or decide which screens the prototype needs.',
  'chat.mode.chat.query1': 'Turn this service idea into a web prototype brief.',
  'chat.mode.chat.query2': 'Help me choose the hero message and primary CTA.',
  'chat.mode.chat.query3': 'Review this landing-page structure and point out missing screens or risky assumptions.',
  'chat.mode.plan.label': "Plan",
  'chat.mode.plan.title': "Plan mode",
  'chat.mode.plan.summary': "Draft the screen list, IA, user flow, and section copy before handing the work to Design.",
  'chat.mode.plan.solves': "Use it before building multi-screen web prototypes such as home, onboarding, dashboard, pricing, and contact flows.",
  'chat.mode.plan.query1': "Plan the screen flow for this web prototype first.",
  'chat.mode.plan.query2': "Outline the landing-page sections and key copy for each section.",
  'chat.mode.plan.query3': "Create an editable plan for a clickable prototype from home to detail screens.",
  'chat.mode.design.label': 'Design',
  'chat.mode.design.title': 'Design mode',
  'chat.mode.design.summary': 'Turn a brief into a responsive web prototype and editable project files.',
  'chat.mode.design.solves': 'Use it for landing pages, SaaS dashboards, service pages, onboarding, and internal tools you can open, review, and revise.',
  'chat.mode.design.query1': 'Create a responsive product-launch web prototype from this brief.',
  'chat.mode.design.query2': 'Build a clickable SaaS dashboard and onboarding prototype.',
  'chat.mode.design.query3': 'Turn this campaign into a web prototype that works well on mobile.',
  'chat.mode.cardBestFor': 'Best for',
  'chat.mode.cardTry': 'Try asking',
  'chat.mode.cardCost': 'Typical usage',
  'chat.mode.chat.cost': 'Light',
  'chat.mode.chat.costNote': 'Clarifies the brief and direction without generating files, so it uses the least.',
  'chat.mode.plan.cost': 'Standard',
  'chat.mode.plan.costNote': 'Creates an editable screen plan before the web prototype is generated.',
  'chat.mode.design.cost': 'Heavy',
  'chat.mode.design.costNote': 'Generates and revises HTML/CSS/JS and preview files, so one run can use the most.',
  ...
  'preview.shareTextDefault': 'design for air template: {title}',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure design for air is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.usefulInfoTip7': 'Enjoying design for air? Star us on GitHub.',
  ...
  'designFiles.usefulInfoTip18': 'Subscribe to design for air on YouTube for tutorials and demos.',
  'designFiles.usefulInfoTip19': 'Follow design for air on LinkedIn for product news.',
  'designFiles.usefulInfoTip20': 'Follow design for air on Xiaohongshu for tips and inspiration.',
  ...
  'assistant.usageTotal': "{count} tokens",
  'assistant.usageInput': "input {count}",
  'assistant.usageOutput': "output {count}",
  'assistant.usageReasoning': "reasoning {count}",
  'assistant.usageCached': "cached {count}",
  'assistant.usageCacheWrite': "cache write {count}",
  ...
  'assistant.shareToOpenDesign': 'Share to design for air',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with design for air — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with design for air — no download needed.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple design for air project folders. New projects are saved as one folder inside the selected base.',
  ...
  'settings.memoryStarterProjectDesc': 'design for air v0.5 — chat-driven design editor',
  ...
  'updater.availableBody': 'design for air {version} is available. It will download before the installer can open.',
  ...
  'updater.installerOpenBody': 'The installer is open. design for air is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit design for air',
  'updater.quitFailedBody': 'The installer is open, but design for air could not quit. Quit design for air before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. design for air will close and open the installer.',
  'updater.readyVersion': 'design for air {version} is ready. design for air will close and open the installer.',
  ...
  'dsManager.createBody': 'Teach design for air your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions design for air follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach design for air your design systems — extract one from a website, then apply it in any chat.',
  ...
  'onboarding.buildBody': 'design for air turns your brand into a reusable design system — then keeps everything you build on-brand and consistent.',
  ...
  'dsCreate.heroEyebrow': "Design system",
  'dsCreate.heroTitle': "Design a system, in minutes",
  'dsCreate.heroBody': "Turn a website or DESIGN.md, plus the context you already have, into a complete design system you can use right away.",
  'dsCreate.heroMetaSteps': "steps",
  'dsCreate.heroMetaMinutes': "~3 min",
  'dsCreate.heroMetaDeliverables': "DESIGN.md · tokens · UI kit · previews",
  'dsCreate.heroStep1Title': "Website or DESIGN.md",
  'dsCreate.heroStep1Desc': "Paste a link, pick a brand, or copy tokens",
  'dsCreate.heroStep2Title': "Add material",
  'dsCreate.heroStep2Desc': "Images, fonts, repo or .fig are optional",
  'dsCreate.heroStep3Title': "Generate",
  'dsCreate.heroStep3Desc': "Fast extract first; AI can refine later",
  'dsCreate.heroShowcaseTitle': "Your design system",
  'dsCreate.heroPalette': "Palette",
  'dsCreate.heroComponents': "Components",
  'dsCreate.heroGhost': "Ghost",
  'dsCreate.sourceProcessing': "Adding source material...",
  'dsCreate.assetEmptyFile': "(empty file)",
  'dsCreate.assetNoPreview': "No inline preview for this file type.",
  'dsCreate.assetDropAria': "Add files - drag and drop, paste, or click to browse",
  'dsCreate.assetDropTitlePrefix': "Drag and drop, paste, or",
  'dsCreate.assetDropBrowse': "browse",
  'dsCreate.assetDropHint': "Images, fonts, logos, PDF, slides, HTML - up to 12 MB each",
  'dsCreate.assetLibraryHint': "or reuse an asset you have already saved",
  'dsCreate.assetStagedAria': "Staged assets",
  'dsCreate.assetClosePreview': "Close preview",
