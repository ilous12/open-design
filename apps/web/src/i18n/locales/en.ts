...
export const en: Dict = {
  ...
  'chat.mode.design.summary': 'For creating or changing concrete web and mobile prototypes.',
  'chat.mode.design.solves': 'Use it when you want design for air to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  'chat.mode.design.query1': 'Create a product launch web prototype from this brief.',
  'chat.mode.design.query2': 'Make a mobile prototype for investor-facing app flows.',
  'chat.mode.design.query3': 'Turn this campaign into responsive web and mobile prototypes.',
