...
import type { ChatSessionMode, RunContextSelection } from '@nn-design/contracts';
...
function AppInner() {
  ...
  // Loading Design For AIR…</div>`) is itself >MIN_VISIBLE_TEXT and would
  ...
  // Home -> onboarding redirect is first-run only. Once the user has
  // completed the CLI/BYOK chooser and reached Home, later runtime edits
  // (or a temporarily unavailable CLI during rescans/settings changes)
  // must NOT yank them back into the onboarding chooser.
  useEffect(() => {
