...
const OPEN_DESIGN_HOST_GLOBAL: typeof import('@nn-design/host').OPEN_DESIGN_HOST_GLOBAL = '__od__';
const OPEN_DESIGN_HOST_VERSION: typeof import('@nn-design/host').OPEN_DESIGN_HOST_VERSION = 2;
...
// preload bundle must not pull in `@nn-design/desktop/main` (it
