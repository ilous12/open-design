...
function Export-WinReleasePublic {
  ...
  @(
    ...
    ""
    "This repository hosts the public release feed for the nn.design desktop app. Installers and update metadata are organized by version, and the app checks this feed for updates."
    ""
    "## Latest installers"
    ""
    "- [Download the latest release](https://github.com/$(Get-EnvValue 'RELEASE_PUBLIC_GH_REPO' '<owner>/<repo>')/releases/latest)"
    "- [View all releases](https://github.com/$(Get-EnvValue 'RELEASE_PUBLIC_GH_REPO' '<owner>/<repo>')/releases)"
    ""
    "Choose the installer that matches the target operating system."
    ""
    "- macOS: ``.dmg``"
    "- Windows: ``setup.exe``"
    ""
    "## Update feed"
    ""
    "- [Latest metadata]($releasePublicOrigin/$latestPrefix/metadata.json)"
    "- [macOS update feed]($releasePublicOrigin/$latestPrefix/latest-mac.yml)"
    "- [Windows update feed]($releasePublicOrigin/$latestPrefix/latest.yml)"
    ""
    "## Feed layout"
    ""
    "This repository stores only the small metadata files used by the app. Large installers, launcher payloads, and checksum files are uploaded as GitHub Release assets for each version."
    ""
    '```text'
    "stable/"
    "  latest/"
    ...
    "## Integrity"
    ""
    "Release assets include SHA-256 checksum files. Use the matching ``.sha256`` file when distributing or verifying installers manually."
    ""
    "## Notes"
    ""
    "This repository is updated by release automation. Issues and feature requests are managed in the product source repository."
  ...
  @(
    ...
    "    <title>nn.design release feed</title>"
    "    <style>"
    ...
    "    <main>"
    '      <section class="panel">'
    "        <h1>nn.design release feed</h1>"
    "        <p>This site hosts the public release feed for the nn.design desktop app. Installers and update metadata are organized by version, and the app checks this feed for updates.</p>"
    "        <h2>Latest installers</h2>"
    "        <ul>"
    "          <li><a href=""https://github.com/$(Get-EnvValue 'RELEASE_PUBLIC_GH_REPO' '<owner>/<repo>')/releases/latest"">Download the latest release</a></li>"
    "          <li><a href=""https://github.com/$(Get-EnvValue 'RELEASE_PUBLIC_GH_REPO' '<owner>/<repo>')/releases"">View all releases</a></li>"
    "        </ul>"
    ...
    "        <h2>Update feed</h2>"
    "        <ul>"
    "          <li><a href=""./$latestPrefix/metadata.json"">Latest metadata</a></li>"
    "          <li><a href=""./$latestPrefix/latest-mac.yml"">macOS update feed</a></li>"
    "          <li><a href=""./$latestPrefix/latest.yml"">Windows update feed</a></li>"
    "        </ul>"
    "        <h2>Feed layout</h2>"
    "        <p>This repository stores only the small metadata files used by the app. Large installers, launcher payloads, and checksum files are uploaded as GitHub Release assets for each version.</p>"
    "        <pre><code>stable/"
    "  latest/"
    "    metadata.json"
    "    latest-mac.yml"
    ...
    "      platforms/</code></pre>"
    "        <h2>Integrity</h2>"
    "        <p>Release assets include SHA-256 checksum files. Use the matching <code>.sha256</code> file when distributing or verifying installers manually.</p>"
    "      </section>"
    "    </main>"
    "  </body>"
    "</html>"
