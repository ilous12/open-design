...
description: Use this plugin when the user wants to create, improve, validate, publish, or submit an design for air plugin using the plugin spec, examples, and PR workflow.
license: MIT
metadata:
