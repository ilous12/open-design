...
# od-contribute — first-contribution flow for Design For AIR
...
- The user wants to *generate* a Skill / Design System from scratch → that's Design For AIR itself. Run OD first, get an artifact, then come back here to ship it.
